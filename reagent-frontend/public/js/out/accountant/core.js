...
if(cljs.core.truth_((function (){var and__3925__auto__ = cljs.core.not.call(null,any_key);
if(and__3925__auto__){
var and__3925__auto____$1 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, ["",null,"_self",null], null), null).call(null,link_target);
if(cljs.core.truth_(and__3925__auto____$1)){
var and__3925__auto____$2 = cljs.core._EQ_.call(null,button,(0));
if(and__3925__auto____$2){
var and__3925__auto____$3 = cljs.core._EQ_.call(null,host,current_host);
if(and__3925__auto____$3){
var and__3925__auto____$4 = ((cljs.core.not.call(null,port)) || (cljs.core._EQ_.call(null,[cljs.core.str.cljs$core$IFn$_invoke$arity$1(port)].join(''),[cljs.core.str.cljs$core$IFn$_invoke$arity$1(current_port)].join(''))));
 ...
 */
accountant.core.configure_navigation_BANG_ = (function accountant$core$configure_navigation_BANG_(p__40668){
var map__40669 = p__40668;
var map__40669__$1 = ((((!((map__40669 == null)))?(((((map__40669.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__40669.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__40669):map__40669);
var nav_handler = cljs.core.get.call(null,map__40669__$1,new cljs.core.Keyword(null,"nav-handler","nav-handler",2039495484));
var path_exists_QMARK_ = cljs.core.get.call(null,map__40669__$1,new cljs.core.Keyword(null,"path-exists?","path-exists?",1473384514));
var reload_same_path_QMARK_ = cljs.core.get.call(null,map__40669__$1,new cljs.core.Keyword(null,"reload-same-path?","reload-same-path?",1981904231));
...
var params = cljs.core.map.call(null,(function (p1__40671_SHARP_){
return cljs.core.name.call(null,p1__40671_SHARP_);
...
return clojure.string.join.call(null,"=",p1__40672_SHARP_);
});})(params,values,pairs))
,pairs));
});
/**
...
//# sourceMappingURL=core.js.map?rel=1553997021032
