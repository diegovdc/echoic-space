...
views.sonos.is_mobile_or_tablet = (function (){var target_obj_37809 = deps;
var _STAR_runtime_state_STAR_37811 = oops.state._STAR_runtime_state_STAR_;
oops.state._STAR_runtime_state_STAR_ = oops.state.prepare_state.call(null,target_obj_37809,(new Error()),function(){arguments[0].apply(console,Array.prototype.slice.call(arguments,1))});

try{var next_obj_37810 = ((oops.core.validate_object_access_dynamically.call(null,target_obj_37809,(0),"isMobileOrTablet",true,true,false))?(target_obj_37809["isMobileOrTablet"]):null);
return next_obj_37810;
}finally {oops.state._STAR_runtime_state_STAR_ = _STAR_runtime_state_STAR_37811;
}})().call(null);
views.sonos.Howl = (function (){var target_obj_37812 = deps;
var _STAR_runtime_state_STAR_37814 = oops.state._STAR_runtime_state_STAR_;
oops.state._STAR_runtime_state_STAR_ = oops.state.prepare_state.call(null,target_obj_37812,(new Error()),function(){arguments[0].apply(console,Array.prototype.slice.call(arguments,1))});

try{var next_obj_37813 = ((oops.core.validate_object_access_dynamically.call(null,target_obj_37812,(0),"Howl",true,true,false))?(target_obj_37812["Howl"]):null);
return next_obj_37813;
}finally {oops.state._STAR_runtime_state_STAR_ = _STAR_runtime_state_STAR_37814;
}})();
views.sonos.Howler = (function (){var target_obj_37815 = deps;
var _STAR_runtime_state_STAR_37817 = oops.state._STAR_runtime_state_STAR_;
oops.state._STAR_runtime_state_STAR_ = oops.state.prepare_state.call(null,target_obj_37815,(new Error()),function(){arguments[0].apply(console,Array.prototype.slice.call(arguments,1))});

try{var next_obj_37816 = ((oops.core.validate_object_access_dynamically.call(null,target_obj_37815,(0),"Howler",true,true,false))?(target_obj_37815["Howler"]):null);
return next_obj_37816;
}finally {oops.state._STAR_runtime_state_STAR_ = _STAR_runtime_state_STAR_37817;
}})();
...
var track = new cljs.core.Keyword(null,"attributes","attributes",-74013604).cljs$core$IFn$_invoke$arity$1(cljs.core.rand_nth.call(null,cljs.core.filter.call(null,(function (p1__37818_SHARP_){
var and__3925__auto__ = cljs.core.not_EQ_.call(null,cljs.core.get_in.call(null,p1__37818_SHARP_,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"attributes","attributes",-74013604),new cljs.core.Keyword(null,"title","title",636505583)], null)),cljs.core.get_in.call(null,cljs.core.deref.call(null,frontend.state.player_state),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"now-playing","now-playing",1487806653),new cljs.core.Keyword(null,"title","title",636505583)], null)));
if(and__3925__auto__){
return cljs.core.get_in.call(null,p1__37818_SHARP_,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"attributes","attributes",-74013604),new cljs.core.Keyword(null,"file_name","file_name",2030201601)], null));
} else {
return and__3925__auto__;
}
...
cljs.core.filter.call(null,(function (p1__37819_SHARP_){
return cljs.core.not_EQ_.call(null,null,cljs.core.get_in.call(null,p1__37819_SHARP_,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"attributes","attributes",-74013604),new cljs.core.Keyword(null,"file_name","file_name",2030201601)], null)));
}));
...
return cljs.core._EQ_.call(null,cljs.core.get_in.call(null,p1__37820_SHARP_,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"attributes","attributes",-74013604),new cljs.core.Keyword(null,"slug","slug",2029314850)], null)),single);
...
var and__3925__auto__ = cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"single","single",1551466437).cljs$core$IFn$_invoke$arity$1(cljs.core.deref.call(null,frontend.state.app_state)),cljs.core.get_in.call(null,p1__37822_SHARP_,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"attributes","attributes",-74013604),new cljs.core.Keyword(null,"slug","slug",2029314850)], null)));
if(and__3925__auto__){
var and__3925__auto____$1 = cljs.core.get_in.call(null,p1__37822_SHARP_,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"attributes","attributes",-74013604),new cljs.core.Keyword(null,"file_name","file_name",2030201601)], null));
...
//# sourceMappingURL=sonos.js.map?rel=1553576543945
