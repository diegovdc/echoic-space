...
views.sonos.is_mobile_or_tablet = (function (){var target_obj_32386 = deps;
var _STAR_runtime_state_STAR_32388 = oops.state._STAR_runtime_state_STAR_;
oops.state._STAR_runtime_state_STAR_ = oops.state.prepare_state.call(null,target_obj_32386,(new Error()),function(){arguments[0].apply(console,Array.prototype.slice.call(arguments,1))});

try{var next_obj_32387 = ((oops.core.validate_object_access_dynamically.call(null,target_obj_32386,(0),"isMobileOrTablet",true,true,false))?(target_obj_32386["isMobileOrTablet"]):null);
return next_obj_32387;
}finally {oops.state._STAR_runtime_state_STAR_ = _STAR_runtime_state_STAR_32388;
}})().call(null);
...
return cljs.core.swap_BANG_.call(null,frontend.state.player_state,cljs.core.assoc,new cljs.core.Keyword(null,"is-playing","is-playing",-1699110457),false);
}
});
});
views.sonos.play_random = (function views$sonos$play_random(){
var track = new cljs.core.Keyword(null,"attributes","attributes",-74013604).cljs$core$IFn$_invoke$arity$1(cljs.core.rand_nth.call(null,cljs.core.filter.call(null,(function (p1__32389_SHARP_){
var and__3925__auto__ = cljs.core.not_EQ_.call(null,new cljs.core.Keyword(null,"attributes","attributes",-74013604).cljs$core$IFn$_invoke$arity$1(p1__32389_SHARP_),cljs.core.deref.call(null,frontend.state.player_state).call(null,new cljs.core.Keyword(null,"now-playing","now-playing",1487806653)));
if(and__3925__auto__){
return cljs.core.get_in.call(null,p1__32389_SHARP_,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"attributes","attributes",-74013604),new cljs.core.Keyword(null,"file_name","file_name",2030201601)], null));
} else {
...
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"a","a",-2123407586),cljs.core.merge.call(null,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"class","class",-2030961996),views.sonos.b.call(null,"playing"),new cljs.core.Keyword(null,"id","id",-1388402092),views.sonos.b.call(null,"playing")], null),(cljs.core.truth_(is_playing)?new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"href","href",-793805698),["/music/",cljs.core.str.cljs$core$IFn$_invoke$arity$1(track_slug)].join('')], null):new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"on-click","on-click",1632826543),views.sonos.toggle_play.call(null,new cljs.core.Keyword(null,"attributes","attributes",-74013604).cljs$core$IFn$_invoke$arity$1(playable_track_if_in_single))], null))),(cljs.core.truth_(is_playing)?track_name:"escucha")], null);
});
...
return cljs.core.not_EQ_.call(null,null,cljs.core.get_in.call(null,p1__32390_SHARP_,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"attributes","attributes",-74013604),new cljs.core.Keyword(null,"file_name","file_name",2030201601)], null)));
}));
...
return cljs.core._EQ_.call(null,cljs.core.get_in.call(null,p1__32391_SHARP_,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"slug","slug",2029314850)], null),single));
...
;
var playable_track_if_in_single = cljs.core.some.call(null,((function (is_playing,track_name,track_slug,icon){
return (function (p1__32393_SHARP_){
var and__3925__auto__ = cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"single","single",1551466437).cljs$core$IFn$_invoke$arity$1(cljs.core.deref.call(null,frontend.state.app_state)),cljs.core.get_in.call(null,p1__32393_SHARP_,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"attributes","attributes",-74013604),new cljs.core.Keyword(null,"slug","slug",2029314850)], null)));
if(and__3925__auto__){
var and__3925__auto____$1 = cljs.core.get_in.call(null,p1__32393_SHARP_,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"attributes","attributes",-74013604),new cljs.core.Keyword(null,"file_name","file_name",2030201601)], null));
