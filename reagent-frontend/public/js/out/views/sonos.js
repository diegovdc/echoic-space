...
views.sonos.is_mobile_or_tablet = (function (){var target_obj_49179 = deps;
var _STAR_runtime_state_STAR_49181 = oops.state._STAR_runtime_state_STAR_;
oops.state._STAR_runtime_state_STAR_ = oops.state.prepare_state.call(null,target_obj_49179,(new Error()),function(){arguments[0].apply(console,Array.prototype.slice.call(arguments,1))});

try{var next_obj_49180 = ((oops.core.validate_object_access_dynamically.call(null,target_obj_49179,(0),"isMobileOrTablet",true,true,false))?(target_obj_49179["isMobileOrTablet"]):null);
return next_obj_49180;
}finally {oops.state._STAR_runtime_state_STAR_ = _STAR_runtime_state_STAR_49181;
}})().call(null);
views.sonos.Howl = (function (){var target_obj_49182 = deps;
var _STAR_runtime_state_STAR_49184 = oops.state._STAR_runtime_state_STAR_;
oops.state._STAR_runtime_state_STAR_ = oops.state.prepare_state.call(null,target_obj_49182,(new Error()),function(){arguments[0].apply(console,Array.prototype.slice.call(arguments,1))});

try{var next_obj_49183 = ((oops.core.validate_object_access_dynamically.call(null,target_obj_49182,(0),"Howl",true,true,false))?(target_obj_49182["Howl"]):null);
return next_obj_49183;
}finally {oops.state._STAR_runtime_state_STAR_ = _STAR_runtime_state_STAR_49184;
}})();
views.sonos.Howler = (function (){var target_obj_49185 = deps;
var _STAR_runtime_state_STAR_49187 = oops.state._STAR_runtime_state_STAR_;
oops.state._STAR_runtime_state_STAR_ = oops.state.prepare_state.call(null,target_obj_49185,(new Error()),function(){arguments[0].apply(console,Array.prototype.slice.call(arguments,1))});

try{var next_obj_49186 = ((oops.core.validate_object_access_dynamically.call(null,target_obj_49185,(0),"Howler",true,true,false))?(target_obj_49185["Howler"]):null);
return next_obj_49186;
}finally {oops.state._STAR_runtime_state_STAR_ = _STAR_runtime_state_STAR_49187;
}})();
...
var track = new cljs.core.Keyword(null,"attributes","attributes",-74013604).cljs$core$IFn$_invoke$arity$1(cljs.core.rand_nth.call(null,cljs.core.filter.call(null,(function (p1__49188_SHARP_){
var and__3925__auto__ = cljs.core.not_EQ_.call(null,cljs.core.get_in.call(null,p1__49188_SHARP_,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"attributes","attributes",-74013604),new cljs.core.Keyword(null,"title","title",636505583)], null)),cljs.core.get_in.call(null,cljs.core.deref.call(null,frontend.state.player_state),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"now-playing","now-playing",1487806653),new cljs.core.Keyword(null,"title","title",636505583)], null)));
if(and__3925__auto__){
return cljs.core.get_in.call(null,p1__49188_SHARP_,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"attributes","attributes",-74013604),new cljs.core.Keyword(null,"file_name","file_name",2030201601)], null));
} else {
return and__3925__auto__;
}
...
cljs.core.filter.call(null,(function (p1__49189_SHARP_){
return cljs.core.not_EQ_.call(null,null,cljs.core.get_in.call(null,p1__49189_SHARP_,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"attributes","attributes",-74013604),new cljs.core.Keyword(null,"file_name","file_name",2030201601)], null)));
}));
...
return (function (p1__49190_SHARP_){
return cljs.core._EQ_.call(null,cljs.core.get_in.call(null,p1__49190_SHARP_,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"slug","slug",2029314850)], null),single));
...
return (function (p1__49191_SHARP_){
if(cljs.core.truth_(is_playing)){
return p1__49191_SHARP_;
} else {
return "fa-play";
}
...
var and__3925__auto__ = cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"single","single",1551466437).cljs$core$IFn$_invoke$arity$1(cljs.core.deref.call(null,frontend.state.app_state)),cljs.core.get_in.call(null,p1__49192_SHARP_,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"attributes","attributes",-74013604),new cljs.core.Keyword(null,"slug","slug",2029314850)], null)));
if(and__3925__auto__){
var and__3925__auto____$1 = cljs.core.get_in.call(null,p1__49192_SHARP_,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"attributes","attributes",-74013604),new cljs.core.Keyword(null,"file_name","file_name",2030201601)], null));
if(cljs.core.truth_(and__3925__auto____$1)){
return p1__49192_SHARP_;
} else {
