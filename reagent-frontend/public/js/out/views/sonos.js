...
views.sonos.is_mobile_or_tablet = (function (){var target_obj_55968 = deps;
var _STAR_runtime_state_STAR_55970 = oops.state._STAR_runtime_state_STAR_;
oops.state._STAR_runtime_state_STAR_ = oops.state.prepare_state.call(null,target_obj_55968,(new Error()),function(){arguments[0].apply(console,Array.prototype.slice.call(arguments,1))});

try{var next_obj_55969 = ((oops.core.validate_object_access_dynamically.call(null,target_obj_55968,(0),"isMobileOrTablet",true,true,false))?(target_obj_55968["isMobileOrTablet"]):null);
return next_obj_55969;
}finally {oops.state._STAR_runtime_state_STAR_ = _STAR_runtime_state_STAR_55970;
}})().call(null);
views.sonos.Howl = (function (){var target_obj_55971 = deps;
var _STAR_runtime_state_STAR_55973 = oops.state._STAR_runtime_state_STAR_;
oops.state._STAR_runtime_state_STAR_ = oops.state.prepare_state.call(null,target_obj_55971,(new Error()),function(){arguments[0].apply(console,Array.prototype.slice.call(arguments,1))});

try{var next_obj_55972 = ((oops.core.validate_object_access_dynamically.call(null,target_obj_55971,(0),"Howl",true,true,false))?(target_obj_55971["Howl"]):null);
return next_obj_55972;
}finally {oops.state._STAR_runtime_state_STAR_ = _STAR_runtime_state_STAR_55973;
}})();
views.sonos.Howler = (function (){var target_obj_55974 = deps;
var _STAR_runtime_state_STAR_55976 = oops.state._STAR_runtime_state_STAR_;
oops.state._STAR_runtime_state_STAR_ = oops.state.prepare_state.call(null,target_obj_55974,(new Error()),function(){arguments[0].apply(console,Array.prototype.slice.call(arguments,1))});

try{var next_obj_55975 = ((oops.core.validate_object_access_dynamically.call(null,target_obj_55974,(0),"Howler",true,true,false))?(target_obj_55974["Howler"]):null);
return next_obj_55975;
}finally {oops.state._STAR_runtime_state_STAR_ = _STAR_runtime_state_STAR_55976;
}})();
...
var howl = cljs.core.get_in.call(null,cljs.core.deref.call(null,frontend.state.player_state),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"now-playing","now-playing",1487806653),new cljs.core.Keyword(null,"howl","howl",2017498573)], null));
var is_playing = new cljs.core.Keyword(null,"is-playing","is-playing",-1699110457).cljs$core$IFn$_invoke$arity$1(cljs.core.deref.call(null,frontend.state.player_state));
...
var seek = howl.seek();
return cljs.core.swap_BANG_.call(null,frontend.state.player_state,cljs.core.assoc,new cljs.core.Keyword(null,"track-data","track-data",-2061070323),new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"duration","duration",1444101068),frontend.helpers.secondsToMinutes.call(null,duration),new cljs.core.Keyword(null,"elapsed","elapsed",-1293489698),frontend.helpers.secondsToMinutes.call(null,seek),new cljs.core.Keyword(null,"percentage","percentage",-1610213650),frontend.helpers.percentage.call(null,seek,duration)], null));
} else {
return null;
}
}),(500));
...
cljs.core.swap_BANG_.call(null,frontend.state.player_state,cljs.core.assoc,new cljs.core.Keyword(null,"now-playing","now-playing",1487806653),cljs.core.assoc.call(null,track_to_play,new cljs.core.Keyword(null,"howl","howl",2017498573),(new views.sonos.Howl(cljs.core.clj__GT_js.call(null,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"src","src",-1651076051),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [frontend.helpers.make_audio_url.call(null,track_to_play)], null),new cljs.core.Keyword(null,"html5","html5",1541457142),true], null))))));
} else {
}
...
cljs.core.get_in.call(null,cljs.core.deref.call(null,frontend.state.player_state),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"now-playing","now-playing",1487806653),new cljs.core.Keyword(null,"howl","howl",2017498573)], null)).pause();
...
var track = new cljs.core.Keyword(null,"attributes","attributes",-74013604).cljs$core$IFn$_invoke$arity$1(cljs.core.rand_nth.call(null,cljs.core.filter.call(null,(function (p1__55977_SHARP_){
var and__3925__auto__ = cljs.core.not_EQ_.call(null,cljs.core.get_in.call(null,p1__55977_SHARP_,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"attributes","attributes",-74013604),new cljs.core.Keyword(null,"title","title",636505583)], null)),cljs.core.get_in.call(null,cljs.core.deref.call(null,frontend.state.player_state),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"now-playing","now-playing",1487806653),new cljs.core.Keyword(null,"title","title",636505583)], null)));
if(and__3925__auto__){
return cljs.core.get_in.call(null,p1__55977_SHARP_,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"attributes","attributes",-74013604),new cljs.core.Keyword(null,"file_name","file_name",2030201601)], null));
} else {
return and__3925__auto__;
}
...
var on_click = (cljs.core.truth_(playable_track_if_in_single)?views.sonos.toggle_play.call(null,new cljs.core.Keyword(null,"attributes","attributes",-74013604).cljs$core$IFn$_invoke$arity$1(playable_track_if_in_single),true):views.sonos.play_random);
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"a","a",-2123407586),cljs.core.merge.call(null,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"class","class",-2030961996),views.sonos.b.call(null,"playing"),new cljs.core.Keyword(null,"id","id",-1388402092),views.sonos.b.call(null,"playing")], null),(cljs.core.truth_(is_playing)?new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"href","href",-793805698),["/music/",cljs.core.str.cljs$core$IFn$_invoke$arity$1(track_slug)].join('')], null):new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"on-click","on-click",1632826543),on_click], null))),(cljs.core.truth_((function (){var or__3936__auto__ = is_playing;
if(cljs.core.truth_(or__3936__auto__)){
return or__3936__auto__;
} else {
return is_paused;
...
cljs.core.filter.call(null,(function (p1__55978_SHARP_){
return cljs.core.not_EQ_.call(null,null,cljs.core.get_in.call(null,p1__55978_SHARP_,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"attributes","attributes",-74013604),new cljs.core.Keyword(null,"file_name","file_name",2030201601)], null)));
}));

return tracks;
});
views.sonos.find_track_to_play = cljs.core.memoize.call(null,(function (is_single,single,tracks){
if(cljs.core.truth_(is_single)){
return frontend.helpers.find_first.call(null,(function (p1__55979_SHARP_){
return cljs.core._EQ_.call(null,single,cljs.core.get_in.call(null,p1__55979_SHARP_,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"attributes","attributes",-74013604),new cljs.core.Keyword(null,"slug","slug",2029314850)], null)));
}),tracks);
} else {
return frontend.helpers.safe_rand_nth.call(null,cljs.core.PersistentArrayMap.EMPTY,tracks);
}
}));
/**
...
var tracks = views.sonos.tracks_with_audio.call(null,views.helpers.get_entries.call(null,frontend.state.app_state));
...
var is_single = ((cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"page","page",849072397).cljs$core$IFn$_invoke$arity$2(cljs.core.deref.call(null,frontend.state.app_state),new cljs.core.Keyword(null,"music-single","music-single",-2070977446)))) || (cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"page","page",849072397).cljs$core$IFn$_invoke$arity$1(cljs.core.deref.call(null,frontend.state.app_state)),new cljs.core.Keyword(null,"blog-single","blog-single",1335736031))));
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"i","i",-1386841315),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"class","class",-2030961996),views.sonos.sonos.call(null,["icon-play fa ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(icon.call(null,"fa-pause"))].join('')),new cljs.core.Keyword(null,"on-click","on-click",1632826543),views.sonos.toggle_play.call(null,new cljs.core.Keyword(null,"attributes","attributes",-74013604).cljs$core$IFn$_invoke$arity$1(views.sonos.find_track_to_play.call(null,is_single,single,tracks)),((((is_single) && (cljs.core.not.call(null,is_playing)) && (cljs.core.not_EQ_.call(null,currently_playing_track,single))))?true:false))], null)], null);
});
...
var and__3925__auto__ = cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"single","single",1551466437).cljs$core$IFn$_invoke$arity$1(cljs.core.deref.call(null,frontend.state.app_state)),cljs.core.get_in.call(null,p1__55981_SHARP_,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"attributes","attributes",-74013604),new cljs.core.Keyword(null,"slug","slug",2029314850)], null)));
if(and__3925__auto__){
var and__3925__auto____$1 = cljs.core.get_in.call(null,p1__55981_SHARP_,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"attributes","attributes",-74013604),new cljs.core.Keyword(null,"file_name","file_name",2030201601)], null));
if(cljs.core.truth_(and__3925__auto____$1)){
return p1__55981_SHARP_;
} else {
