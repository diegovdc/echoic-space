...
return cljs.core.group_by.call(null,views.music.year,cljs.core.sort.call(null,(function (p1__54823_SHARP_,p2__54822_SHARP_){
return cljs.core.compare.call(null,new cljs.core.Keyword(null,"date","date",-1463434462).cljs$core$IFn$_invoke$arity$1(p2__54822_SHARP_),new cljs.core.Keyword(null,"date","date",-1463434462).cljs$core$IFn$_invoke$arity$1(p1__54823_SHARP_));
}),music));
});
...
return cljs.core.filter.call(null,(function (p1__54824_SHARP_){
return cljs.core.not_EQ_.call(null,cljs.core.PersistentHashSet.EMPTY,clojure.set.intersection.call(null,selected_categories,cljs.core.set.call(null,new cljs.core.Keyword(null,"category","category",-593092832).cljs$core$IFn$_invoke$arity$1(p1__54824_SHARP_))));
}),music);
}
});
...
return (function (){
return cljs.core.swap_BANG_.call(null,views.music.selected_categories,(function (p1__54825_SHARP_){
return views.music.toggle_in_set.call(null,p1__54825_SHARP_,cat);
}));
});
});
...
var music = cljs.core.map.call(null,(function (p1__54826_SHARP_){
return new cljs.core.Keyword(null,"attributes","attributes",-74013604).cljs$core$IFn$_invoke$arity$1(p1__54826_SHARP_);
...
return new cljs.core.Keyword(null,"category","category",-593092832).cljs$core$IFn$_invoke$arity$1(p1__54827_SHARP_);
});})(music))
,music))));
...
//# sourceMappingURL=music.js.map?rel=1552956932242
