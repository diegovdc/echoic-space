...
var page = new cljs.core.Keyword(null,"page","page",849072397).cljs$core$IFn$_invoke$arity$1(cljs.core.deref.call(null,frontend.state.app_state));
if(cljs.core._EQ_.call(null,page,new cljs.core.Keyword(null,"music-single","music-single",-2070977446))){
return "music";
} else {
if(cljs.core._EQ_.call(null,page,new cljs.core.Keyword(null,"blog-single","blog-single",1335736031))){
return "blog";
} else {
return null;
}
...
var app_state = cljs.core.deref.call(null,frontend.state.app_state);
var page = new cljs.core.Keyword(null,"page","page",849072397).cljs$core$IFn$_invoke$arity$1(app_state);
if(cljs.core._EQ_.call(null,page,new cljs.core.Keyword(null,"music-single","music-single",-2070977446))){
return new cljs.core.Keyword(null,"music","music",-1063514396).cljs$core$IFn$_invoke$arity$1(app_state);
} else {
if(cljs.core._EQ_.call(null,page,new cljs.core.Keyword(null,"blog-single","blog-single",1335736031))){
return new cljs.core.Keyword(null,"blog","blog",-302707364).cljs$core$IFn$_invoke$arity$1(app_state);
} else {
return null;
}
}
...
return ["/",cljs.core.str.cljs$core$IFn$_invoke$arity$1(views.music_single.base_url.call(null)),"/",cljs.core.str.cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"slug","slug",2029314850).cljs$core$IFn$_invoke$arity$1(post_attrs)),"/",cljs.core.str.cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"backgroundImage","backgroundImage",1109094965).cljs$core$IFn$_invoke$arity$1(post_attrs))].join('');
});
...
return (function (){
var player = (new YT.Player("player",(function (){var obj49938 = {"videoId":new cljs.core.Keyword(null,"youtube_id","youtube_id",1076585092).cljs$core$IFn$_invoke$arity$1(post_attrs),"events":(function (){var obj49940 = {"onReady":onPlayerReady};
return obj49940;
})()};
return obj49938;
})()));
...
return frontend.helpers.scroll_to.call(null,((cljs.core.not.call(null,cljs.core.deref.call(null,local_state).call(null,new cljs.core.Keyword(null,"show-info","show-info",-822530028))))?(0):(function (p1__49941_SHARP_){
return (p1__49941_SHARP_ - (26));
...
var entries = views.music_single.get_entries.call(null);
var post = views.music_single.find_post.call(null,entries,singleSlug);
...
;
return cljs.core.with_meta.call(null,printed_post,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"component-did-mount","component-did-mount",-1126910518),((function (local_state,entries,post,printed_post){
return (function (){
...
//# sourceMappingURL=music_single.js.map?rel=1553998298225
