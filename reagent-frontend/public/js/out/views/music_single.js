...
return (function (p1__55984_SHARP_){
return (p1__55984_SHARP_ - (26));
...
return ["/",cljs.core.str.cljs$core$IFn$_invoke$arity$1(views.helpers.base_url.call(null,frontend.state.app_state)),"/",cljs.core.str.cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"slug","slug",2029314850).cljs$core$IFn$_invoke$arity$1(post_attrs)),"/",cljs.core.str.cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"backgroundImage","backgroundImage",1109094965).cljs$core$IFn$_invoke$arity$1(post_attrs))].join('');
});
...
return (function (){
var player = (new YT.Player("player",(function (){var obj55986 = {"videoId":new cljs.core.Keyword(null,"youtube_id","youtube_id",1076585092).cljs$core$IFn$_invoke$arity$1(post_attrs),"events":(function (){var obj55988 = {"onReady":onPlayerReady};
return obj55988;
})()};
return obj55986;
})()));
...
return frontend.helpers.scroll_to.call(null,((cljs.core.not.call(null,cljs.core.deref.call(null,local_state).call(null,new cljs.core.Keyword(null,"show-info","show-info",-822530028))))?(0):(function (p1__55989_SHARP_){
return (p1__55989_SHARP_ - (26));
...
return cljs.core.first.call(null,cljs.core.filter.call(null,(function (p1__55990_SHARP_){
return cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"slug","slug",2029314850).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"attributes","attributes",-74013604).cljs$core$IFn$_invoke$arity$1(p1__55990_SHARP_)),slug);
}),tracks));
});
...
var entries = views.helpers.get_entries.call(null,frontend.state.app_state);
...
//# sourceMappingURL=music_single.js.map?rel=1574224105714
