...
return ["(",cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__54501_SHARP_),")"].join('');
}).call(null,clojure.string.join.call(null," ",cljs.core.update_in.call(null,cljs.core.update_in.call(null,cljs.core.subvec.call(null,clojure.string.split.call(null,date,"-"),(1)),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [(0)], null),(function (p1__54499_SHARP_){
return cljs.core.get.call(null,views.helpers.meses,p1__54499_SHARP_);
})),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [(1)], null),(function (p1__54500_SHARP_){
return cljs.core.nth.call(null,clojure.string.split.call(null,p1__54500_SHARP_,"T"),(0));
}))));
});
...
var selected_cats = cljs.core.deref.call(null,selected_categories_atom);
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),"music__category-container"], null),cljs.core.map.call(null,((function (selected_cats){
return (function (cat){
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"span","span",1394872991),new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"key","key",-1516042587),cat,new cljs.core.Keyword(null,"class","class",-2030961996),["music__category ",cljs.core.str.cljs$core$IFn$_invoke$arity$1((cljs.core.truth_(cljs.core.some.call(null,((function (selected_cats){
return (function (p1__54502_SHARP_){
return cljs.core._EQ_.call(null,p1__54502_SHARP_,cat);
});})(selected_cats))
,selected_cats))?"selected":null))].join(''),new cljs.core.Keyword(null,"on-click","on-click",1632826543),frontend.helpers.toggle_category.call(null,selected_categories_atom,cat)], null),cat], null);
});})(selected_cats))
,categories)], null);
});
views.helpers.base_url = (function views$helpers$base_url(app_state){
var page = new cljs.core.Keyword(null,"page","page",849072397).cljs$core$IFn$_invoke$arity$1(cljs.core.deref.call(null,app_state));
...
var app_state_SINGLEQUOTE_ = cljs.core.deref.call(null,app_state);
var page = new cljs.core.Keyword(null,"page","page",849072397).cljs$core$IFn$_invoke$arity$1(app_state_SINGLEQUOTE_);
if(cljs.core._EQ_.call(null,page,new cljs.core.Keyword(null,"music-single","music-single",-2070977446))){
return new cljs.core.Keyword(null,"music","music",-1063514396).cljs$core$IFn$_invoke$arity$1(app_state_SINGLEQUOTE_);
} else {
if(cljs.core._EQ_.call(null,page,new cljs.core.Keyword(null,"blog-single","blog-single",1335736031))){
return new cljs.core.Keyword(null,"blog","blog",-302707364).cljs$core$IFn$_invoke$arity$1(app_state_SINGLEQUOTE_);
} else {
return null;
}
}
...
//# sourceMappingURL=helpers.js.map?rel=1574224102819
