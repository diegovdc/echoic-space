...
return cljs.core.group_by.call(null,frontend.helpers.year,cljs.core.sort.call(null,(function (p1__54494_SHARP_,p2__54493_SHARP_){
return cljs.core.compare.call(null,new cljs.core.Keyword(null,"date","date",-1463434462).cljs$core$IFn$_invoke$arity$1(p2__54493_SHARP_),new cljs.core.Keyword(null,"date","date",-1463434462).cljs$core$IFn$_invoke$arity$1(p1__54494_SHARP_));
}),entry));
});
...
return cljs.core.filter.call(null,(function (p1__54495_SHARP_){
return cljs.core.not_EQ_.call(null,cljs.core.PersistentHashSet.EMPTY,clojure.set.intersection.call(null,selected_categories,cljs.core.set.call(null,new cljs.core.Keyword(null,"category","category",-593092832).cljs$core$IFn$_invoke$arity$1(p1__54495_SHARP_))));
}),entry);
}
});
...
return (function (){
return cljs.core.swap_BANG_.call(null,selected_categories_atom,(function (p1__54496_SHARP_){
return frontend.helpers.toggle_in_set.call(null,p1__54496_SHARP_,cat);
}));
});
});
...
//# sourceMappingURL=helpers.js.map?rel=1574224102800
