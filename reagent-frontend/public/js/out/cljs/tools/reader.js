...
return cljs.tools.reader.read_tagged.call(null,(function (){var G__37283 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__37283,ch);
...
if(("\\" === ch__$1)){
var ch_37284__$2 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
if((ch_37284__$2 == null)){
cljs.tools.reader.impl.errors.throw_eof_reading.call(null,rdr,new cljs.core.Keyword(null,"regex","regex",939488856),sb);
} else {
}

sb.append(ch_37284__$2);
} else {
}

var G__37285 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch__$1 = G__37285;
continue;
}
}
...
var vec__37293 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__37293,(0),null);
var start_column = cljs.core.nth.call(null,vec__37293,(1),null);
...
var G__37296 = cljs.core.conj_BANG_.call(null,a,form);
a = G__37296;
continue;
}
}
...
var _STAR_read_delim_STAR_37297 = cljs.tools.reader._STAR_read_delim_STAR_;
...
}finally {cljs.tools.reader._STAR_read_delim_STAR_ = _STAR_read_delim_STAR_37297;
}});
/**
 * Read in a list, including its location if the reader is an indexing reader
 */
cljs.tools.reader.read_list = (function cljs$tools$reader$read_list(rdr,_,opts,pending_forms){
var vec__37298 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__37298,(0),null);
var start_column = cljs.core.nth.call(null,vec__37298,(1),null);
...
var vec__37301 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__37301,(0),null);
var end_column = cljs.core.nth.call(null,vec__37301,(1),null);
...
var vec__37304 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__37304,(0),null);
var start_column = cljs.core.nth.call(null,vec__37304,(1),null);
...
var vec__37307 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__37307,(0),null);
var end_column = cljs.core.nth.call(null,vec__37307,(1),null);
...
var vec__37310 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__37310,(0),null);
var start_column = cljs.core.nth.call(null,vec__37310,(1),null);
...
var vec__37313 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__37313,(0),null);
var end_column = cljs.core.nth.call(null,vec__37313,(1),null);
...
var sb = (function (){var G__37316 = (new goog.string.StringBuffer());
G__37316.append(initch);
...
var G__37318 = (function (){var G__37317 = sb;
G__37317.append(ch);

return G__37317;
})();
var G__37319 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
sb = G__37318;
ch = G__37319;
continue;
}
...
switch (G__37322) {
case "\\":
var G__37326 = (function (){var G__37323 = sb;
G__37323.append(cljs.tools.reader.escape_char.call(null,sb,reader));
...
break;
default:
var G__37328 = (function (){var G__37324 = sb;
G__37324.append(ch);

return G__37324;
})();
var G__37329 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__37328;
ch = G__37329;
continue;
...
var vec__37330 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__37330,(0),null);
var end_column = cljs.core.nth.call(null,vec__37330,(1),null);
...
var vec__37333 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__37333,(0),null);
var column = cljs.core.nth.call(null,vec__37333,(1),null);
...
var vec__37338 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__37338,(0),null);
var column = cljs.core.nth.call(null,vec__37338,(1),null);
...
var vec__37343 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__37343,(0),null);
var column = cljs.core.nth.call(null,vec__37343,(1),null);
var m = cljs.tools.reader.impl.utils.desugar_meta.call(null,cljs.tools.reader.read_STAR_.call(null,rdr,true,null,opts,pending_forms));
if(cljs.core.map_QMARK_.call(null,m)){
} else {
cljs.tools.reader.impl.errors.throw_bad_metadata.call(null,rdr,m);
...
var vec__37348 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__37348,(0),null);
var start_column = cljs.core.nth.call(null,vec__37348,(1),null);
...
var vec__37351 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__37351,(0),null);
var end_column = cljs.core.nth.call(null,vec__37351,(1),null);
...
var G__37354 = rdr;
cljs.tools.reader.read_STAR_.call(null,G__37354,true,null,opts,pending_forms);
...
var G__37355 = sym;
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"NaN","NaN",666918153,null),G__37355)){
return Number.NaN;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"-Inf","-Inf",-2123243689,null),G__37355)){
return Number.NEGATIVE_INFINITY;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"Inf","Inf",647172781,null),G__37355)){
...
var _STAR_suppress_read_STAR_37356 = cljs.tools.reader._STAR_suppress_read_STAR_;
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR_37356;
}});
...
var G__37357 = cljs.tools.reader.read_STAR_.call(null,rdr,false,cljs.tools.reader.READ_EOF,")",opts,pending_forms);
cljs.tools.reader.check_eof_error.call(null,G__37357,rdr,first_line);

cljs.tools.reader.check_invalid_read_cond.call(null,G__37357,rdr,first_line);
...
var G__37361 = matched;
var G__37362 = cljs.tools.reader.read_suppress.call(null,first_line,rdr,opts,pending_forms);
matched = G__37361;
finished = G__37362;
continue;
} else {
...
var _STAR_suppress_read_STAR_37363 = cljs.tools.reader._STAR_suppress_read_STAR_;
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR_37363;
}}
} else {
return cljs.tools.reader.impl.errors.throw_eof_in_character.call(null,rdr);
}
...
var arg_env37364 = cljs.tools.reader.arg_env;
cljs.tools.reader.arg_env = cljs.core.sorted_map.call(null);

try{var form = cljs.tools.reader.read_STAR_.call(null,(function (){var G__37365 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__37365,"(");
...
var G__37366 = (i + (1));
var G__37367 = cljs.core.conj_BANG_.call(null,args,(function (){var or__3936__auto__ = cljs.core.get.call(null,cljs.tools.reader.arg_env,i);
if(cljs.core.truth_(or__3936__auto__)){
return or__3936__auto__;
} else {
...
}finally {cljs.tools.reader.arg_env = arg_env37364;
}});
/**
...
var ch = temp__5455__auto__;
if(cljs.core._EQ_.call(null,"@",ch)){
return cljs.tools.reader.wrapping_reader.call(null,new cljs.core.Symbol("clojure.core","unquote-splicing","clojure.core/unquote-splicing",-552003150,null)).call(null,(function (){var G__37368 = rdr;
cljs.tools.reader.reader_types.read_char.call(null,G__37368);
...
var G__37369 = cljs.core.next.call(null,s__$1);
var G__37370 = ret;
s__$1 = G__37369;
r = G__37370;
continue;
...
var G__37371 = cljs.core.next.call(null,s);
var G__37372 = cljs.core.conj_BANG_.call(null,cljs.core.conj_BANG_.call(null,key_vals,cljs.core.key.call(null,e)),cljs.core.val.call(null,e));
s = G__37371;
key_vals = G__37372;
continue;
} else {
...
var gensym_env37376 = cljs.tools.reader.gensym_env;
...
}finally {cljs.tools.reader.gensym_env = gensym_env37376;
}});
...
var temp__5455__auto__ = ((cljs.core._EQ_.call(null,token,":"))?cljs.core.ns_name.call(null,cljs.core._STAR_ns_STAR_):((cljs.core._EQ_.call(null,":",cljs.core.first.call(null,token)))?(function (){var G__37377 = token;
var G__37377__$1 = (((G__37377 == null))?null:cljs.core.subs.call(null,G__37377,(1)));
var G__37377__$2 = (((G__37377__$1 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__37377__$1));
var G__37377__$3 = (((G__37377__$2 == null))?null:cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__37377__$2));
var G__37377__$4 = (((G__37377__$3 == null))?null:cljs.core.symbol.call(null,G__37377__$3));
if((G__37377__$4 == null)){
return null;
} else {
return cljs.tools.reader.resolve_ns.call(null,G__37377__$4);
}
})():(function (){var G__37378 = token;
var G__37378__$1 = (((G__37378 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__37378));
if((G__37378__$1 == null)){
return null;
} else {
return cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__37378__$1);
}
})()
));
if(cljs.core.truth_(temp__5455__auto__)){
...
}catch (e37385){if((e37385 instanceof Error)){
var e = e37385;
...
cljs.tools.reader.read.cljs$core$IFn$_invoke$arity$2 = (function (p__37389,reader){
...
var eof = cljs.core.get.call(null,map__37390__$1,new cljs.core.Keyword(null,"eof","eof",-489063237),new cljs.core.Keyword(null,"eofthrow","eofthrow",-334166531));
...
var len__4517__auto___37398 = arguments.length;
var i__4518__auto___37399 = (0);
while(true){
if((i__4518__auto___37399 < len__4517__auto___37398)){
args__4520__auto__.push((arguments[i__4518__auto___37399]));

var G__37400 = (i__4518__auto___37399 + (1));
i__4518__auto___37399 = G__37400;
continue;
} else {
}
break;
...
/** @this {Function} */
cljs.tools.reader.read_PLUS_string.cljs$lang$applyTo = (function (seq37396){
var G__37397 = cljs.core.first.call(null,seq37396);
var seq37396__$1 = cljs.core.next.call(null,seq37396);
var self__4504__auto__ = this;
return self__4504__auto__.cljs$core$IFn$_invoke$arity$variadic(G__37397,seq37396__$1);
});


//# sourceMappingURL=reader.js.map?rel=1553576542921
