...
var G__31859 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch = G__31859;
continue;
}
break;
...
return cljs.tools.reader.read_tagged.call(null,(function (){var G__31860 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__31860,ch);
...
if(("\\" === ch__$1)){
var ch_31861__$2 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
if((ch_31861__$2 == null)){
cljs.tools.reader.impl.errors.throw_eof_reading.call(null,rdr,new cljs.core.Keyword(null,"regex","regex",939488856),sb);
} else {
}

sb.append(ch_31861__$2);
} else {
}

var G__31862 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch__$1 = G__31862;
continue;
}
}
...
var vec__31870 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__31870,(0),null);
var start_column = cljs.core.nth.call(null,vec__31870,(1),null);
...
var G__31873 = cljs.core.conj_BANG_.call(null,a,form);
a = G__31873;
continue;
}
}
...
var _STAR_read_delim_STAR_31874 = cljs.tools.reader._STAR_read_delim_STAR_;
...
}finally {cljs.tools.reader._STAR_read_delim_STAR_ = _STAR_read_delim_STAR_31874;
}});
/**
 * Read in a list, including its location if the reader is an indexing reader
 */
cljs.tools.reader.read_list = (function cljs$tools$reader$read_list(rdr,_,opts,pending_forms){
var vec__31875 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__31875,(0),null);
var start_column = cljs.core.nth.call(null,vec__31875,(1),null);
...
var vec__31878 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__31878,(0),null);
var end_column = cljs.core.nth.call(null,vec__31878,(1),null);
...
var vec__31881 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__31881,(0),null);
var start_column = cljs.core.nth.call(null,vec__31881,(1),null);
...
var vec__31884 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__31884,(0),null);
var end_column = cljs.core.nth.call(null,vec__31884,(1),null);
...
var vec__31887 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__31887,(0),null);
var start_column = cljs.core.nth.call(null,vec__31887,(1),null);
...
var vec__31890 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__31890,(0),null);
var end_column = cljs.core.nth.call(null,vec__31890,(1),null);
...
var sb = (function (){var G__31893 = (new goog.string.StringBuffer());
G__31893.append(initch);
...
var G__31895 = (function (){var G__31894 = sb;
G__31894.append(ch);

return G__31894;
})();
var G__31896 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
sb = G__31895;
ch = G__31896;
continue;
}
...
switch (G__31899) {
case "\\":
var G__31903 = (function (){var G__31900 = sb;
G__31900.append(cljs.tools.reader.escape_char.call(null,sb,reader));

return G__31900;
})();
var G__31904 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__31903;
ch = G__31904;
continue;
...
break;
default:
var G__31905 = (function (){var G__31901 = sb;
G__31901.append(ch);

return G__31901;
})();
var G__31906 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__31905;
ch = G__31906;
continue;
...
var vec__31907 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__31907,(0),null);
var end_column = cljs.core.nth.call(null,vec__31907,(1),null);
...
var vec__31910 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__31910,(0),null);
var column = cljs.core.nth.call(null,vec__31910,(1),null);
...
var vec__31915 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__31915,(0),null);
var column = cljs.core.nth.call(null,vec__31915,(1),null);
...
var vec__31920 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__31920,(0),null);
var column = cljs.core.nth.call(null,vec__31920,(1),null);
var m = cljs.tools.reader.impl.utils.desugar_meta.call(null,cljs.tools.reader.read_STAR_.call(null,rdr,true,null,opts,pending_forms));
if(cljs.core.map_QMARK_.call(null,m)){
} else {
cljs.tools.reader.impl.errors.throw_bad_metadata.call(null,rdr,m);
...
var vec__31925 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__31925,(0),null);
var start_column = cljs.core.nth.call(null,vec__31925,(1),null);
...
var vec__31928 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__31928,(0),null);
var end_column = cljs.core.nth.call(null,vec__31928,(1),null);
...
var G__31931 = rdr;
cljs.tools.reader.read_STAR_.call(null,G__31931,true,null,opts,pending_forms);
...
var G__31932 = sym;
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"NaN","NaN",666918153,null),G__31932)){
return Number.NaN;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"-Inf","-Inf",-2123243689,null),G__31932)){
return Number.NEGATIVE_INFINITY;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"Inf","Inf",647172781,null),G__31932)){
...
var _STAR_suppress_read_STAR_31933 = cljs.tools.reader._STAR_suppress_read_STAR_;
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR_31933;
}});
...
var G__31934 = cljs.tools.reader.read_STAR_.call(null,rdr,false,cljs.tools.reader.READ_EOF,")",opts,pending_forms);
cljs.tools.reader.check_eof_error.call(null,G__31934,rdr,first_line);

cljs.tools.reader.check_invalid_read_cond.call(null,G__31934,rdr,first_line);
...
var G__31938 = matched;
var G__31939 = cljs.tools.reader.read_suppress.call(null,first_line,rdr,opts,pending_forms);
matched = G__31938;
finished = G__31939;
continue;
} else {
...
var _STAR_suppress_read_STAR_31940 = cljs.tools.reader._STAR_suppress_read_STAR_;
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR_31940;
}}
} else {
return cljs.tools.reader.impl.errors.throw_eof_in_character.call(null,rdr);
}
...
var arg_env31941 = cljs.tools.reader.arg_env;
cljs.tools.reader.arg_env = cljs.core.sorted_map.call(null);

try{var form = cljs.tools.reader.read_STAR_.call(null,(function (){var G__31942 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__31942,"(");
...
var G__31943 = (i + (1));
var G__31944 = cljs.core.conj_BANG_.call(null,args,(function (){var or__3936__auto__ = cljs.core.get.call(null,cljs.tools.reader.arg_env,i);
if(cljs.core.truth_(or__3936__auto__)){
return or__3936__auto__;
} else {
...
}finally {cljs.tools.reader.arg_env = arg_env31941;
}});
/**
...
var ch = temp__5455__auto__;
if(cljs.core._EQ_.call(null,"@",ch)){
return cljs.tools.reader.wrapping_reader.call(null,new cljs.core.Symbol("clojure.core","unquote-splicing","clojure.core/unquote-splicing",-552003150,null)).call(null,(function (){var G__31945 = rdr;
cljs.tools.reader.reader_types.read_char.call(null,G__31945);
...
var G__31946 = cljs.core.next.call(null,s__$1);
var G__31947 = ret;
s__$1 = G__31946;
r = G__31947;
continue;
...
var G__31948 = cljs.core.next.call(null,s);
var G__31949 = cljs.core.conj_BANG_.call(null,cljs.core.conj_BANG_.call(null,key_vals,cljs.core.key.call(null,e)),cljs.core.val.call(null,e));
s = G__31948;
key_vals = G__31949;
continue;
} else {
...
var gensym_env31953 = cljs.tools.reader.gensym_env;
...
}finally {cljs.tools.reader.gensym_env = gensym_env31953;
}});
...
var temp__5455__auto__ = ((cljs.core._EQ_.call(null,token,":"))?cljs.core.ns_name.call(null,cljs.core._STAR_ns_STAR_):((cljs.core._EQ_.call(null,":",cljs.core.first.call(null,token)))?(function (){var G__31954 = token;
var G__31954__$1 = (((G__31954 == null))?null:cljs.core.subs.call(null,G__31954,(1)));
var G__31954__$2 = (((G__31954__$1 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__31954__$1));
var G__31954__$3 = (((G__31954__$2 == null))?null:cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__31954__$2));
var G__31954__$4 = (((G__31954__$3 == null))?null:cljs.core.symbol.call(null,G__31954__$3));
if((G__31954__$4 == null)){
return null;
} else {
return cljs.tools.reader.resolve_ns.call(null,G__31954__$4);
}
})():(function (){var G__31955 = token;
var G__31955__$1 = (((G__31955 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__31955));
if((G__31955__$1 == null)){
return null;
} else {
return cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__31955__$1);
}
})()
));
if(cljs.core.truth_(temp__5455__auto__)){
...
}catch (e31962){if((e31962 instanceof Error)){
var e = e31962;
...
cljs.tools.reader.read.cljs$core$IFn$_invoke$arity$2 = (function (p__31966,reader){
var map__31967 = p__31966;
var map__31967__$1 = ((((!((map__31967 == null)))?(((((map__31967.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__31967.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__31967):map__31967);
var opts = map__31967__$1;
var eof = cljs.core.get.call(null,map__31967__$1,new cljs.core.Keyword(null,"eof","eof",-489063237),new cljs.core.Keyword(null,"eofthrow","eofthrow",-334166531));
...
var len__4517__auto___31975 = arguments.length;
var i__4518__auto___31976 = (0);
while(true){
if((i__4518__auto___31976 < len__4517__auto___31975)){
args__4520__auto__.push((arguments[i__4518__auto___31976]));

var G__31977 = (i__4518__auto___31976 + (1));
i__4518__auto___31976 = G__31977;
continue;
} else {
}
break;
...
/** @this {Function} */
cljs.tools.reader.read_PLUS_string.cljs$lang$applyTo = (function (seq31973){
...
return self__4504__auto__.cljs$core$IFn$_invoke$arity$variadic(G__31974,seq31973__$1);
});


//# sourceMappingURL=reader.js.map?rel=1552590663566
