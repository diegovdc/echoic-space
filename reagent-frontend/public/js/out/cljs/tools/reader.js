...
return cljs.tools.reader.read_tagged.call(null,(function (){var G__39800 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__39800,ch);
...
if(("\\" === ch__$1)){
var ch_39801__$2 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
if((ch_39801__$2 == null)){
cljs.tools.reader.impl.errors.throw_eof_reading.call(null,rdr,new cljs.core.Keyword(null,"regex","regex",939488856),sb);
} else {
}

sb.append(ch_39801__$2);
} else {
}

var G__39802 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch__$1 = G__39802;
continue;
}
}
...
var vec__39810 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__39810,(0),null);
var start_column = cljs.core.nth.call(null,vec__39810,(1),null);
...
var G__39813 = cljs.core.conj_BANG_.call(null,a,form);
a = G__39813;
continue;
}
}
...
var _STAR_read_delim_STAR_39814 = cljs.tools.reader._STAR_read_delim_STAR_;
...
}finally {cljs.tools.reader._STAR_read_delim_STAR_ = _STAR_read_delim_STAR_39814;
}});
/**
 * Read in a list, including its location if the reader is an indexing reader
 */
cljs.tools.reader.read_list = (function cljs$tools$reader$read_list(rdr,_,opts,pending_forms){
var vec__39815 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__39815,(0),null);
var start_column = cljs.core.nth.call(null,vec__39815,(1),null);
...
var vec__39818 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__39818,(0),null);
var end_column = cljs.core.nth.call(null,vec__39818,(1),null);
...
var vec__39821 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__39821,(0),null);
var start_column = cljs.core.nth.call(null,vec__39821,(1),null);
...
var vec__39824 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__39824,(0),null);
var end_column = cljs.core.nth.call(null,vec__39824,(1),null);
...
var vec__39827 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__39827,(0),null);
var start_column = cljs.core.nth.call(null,vec__39827,(1),null);
...
var vec__39830 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__39830,(0),null);
var end_column = cljs.core.nth.call(null,vec__39830,(1),null);
...
var sb = (function (){var G__39833 = (new goog.string.StringBuffer());
G__39833.append(initch);
...
var G__39835 = (function (){var G__39834 = sb;
G__39834.append(ch);

return G__39834;
})();
var G__39836 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
sb = G__39835;
ch = G__39836;
continue;
}
...
switch (G__39839) {
case "\\":
var G__39843 = (function (){var G__39840 = sb;
G__39840.append(cljs.tools.reader.escape_char.call(null,sb,reader));

return G__39840;
})();
var G__39844 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__39843;
ch = G__39844;
continue;
...
break;
default:
var G__39845 = (function (){var G__39841 = sb;
G__39841.append(ch);

return G__39841;
})();
var G__39846 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__39845;
ch = G__39846;
continue;
...
var vec__39847 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__39847,(0),null);
var end_column = cljs.core.nth.call(null,vec__39847,(1),null);
...
var vec__39850 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__39850,(0),null);
var column = cljs.core.nth.call(null,vec__39850,(1),null);
...
var vec__39855 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__39855,(0),null);
var column = cljs.core.nth.call(null,vec__39855,(1),null);
...
var vec__39860 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__39860,(0),null);
var column = cljs.core.nth.call(null,vec__39860,(1),null);
var m = cljs.tools.reader.impl.utils.desugar_meta.call(null,cljs.tools.reader.read_STAR_.call(null,rdr,true,null,opts,pending_forms));
if(cljs.core.map_QMARK_.call(null,m)){
} else {
cljs.tools.reader.impl.errors.throw_bad_metadata.call(null,rdr,m);
...
var vec__39865 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__39865,(0),null);
var start_column = cljs.core.nth.call(null,vec__39865,(1),null);
...
var vec__39868 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__39868,(0),null);
var end_column = cljs.core.nth.call(null,vec__39868,(1),null);
...
var G__39871 = rdr;
cljs.tools.reader.read_STAR_.call(null,G__39871,true,null,opts,pending_forms);
...
var G__39872 = sym;
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"NaN","NaN",666918153,null),G__39872)){
return Number.NaN;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"-Inf","-Inf",-2123243689,null),G__39872)){
return Number.NEGATIVE_INFINITY;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"Inf","Inf",647172781,null),G__39872)){
...
var _STAR_suppress_read_STAR_39873 = cljs.tools.reader._STAR_suppress_read_STAR_;
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR_39873;
}});
...
var G__39874 = cljs.tools.reader.read_STAR_.call(null,rdr,false,cljs.tools.reader.READ_EOF,")",opts,pending_forms);
cljs.tools.reader.check_eof_error.call(null,G__39874,rdr,first_line);

cljs.tools.reader.check_invalid_read_cond.call(null,G__39874,rdr,first_line);
...
var G__39878 = matched;
var G__39879 = cljs.tools.reader.read_suppress.call(null,first_line,rdr,opts,pending_forms);
matched = G__39878;
finished = G__39879;
continue;
} else {
...
var _STAR_suppress_read_STAR_39880 = cljs.tools.reader._STAR_suppress_read_STAR_;
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR_39880;
}}
} else {
return cljs.tools.reader.impl.errors.throw_eof_in_character.call(null,rdr);
}
...
var arg_env39881 = cljs.tools.reader.arg_env;
cljs.tools.reader.arg_env = cljs.core.sorted_map.call(null);

try{var form = cljs.tools.reader.read_STAR_.call(null,(function (){var G__39882 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__39882,"(");
...
var G__39883 = (i + (1));
var G__39884 = cljs.core.conj_BANG_.call(null,args,(function (){var or__3936__auto__ = cljs.core.get.call(null,cljs.tools.reader.arg_env,i);
if(cljs.core.truth_(or__3936__auto__)){
return or__3936__auto__;
} else {
...
}finally {cljs.tools.reader.arg_env = arg_env39881;
}});
/**
...
var ch = temp__5455__auto__;
if(cljs.core._EQ_.call(null,"@",ch)){
return cljs.tools.reader.wrapping_reader.call(null,new cljs.core.Symbol("clojure.core","unquote-splicing","clojure.core/unquote-splicing",-552003150,null)).call(null,(function (){var G__39885 = rdr;
cljs.tools.reader.reader_types.read_char.call(null,G__39885);
...
var G__39886 = cljs.core.next.call(null,s__$1);
var G__39887 = ret;
s__$1 = G__39886;
r = G__39887;
continue;
...
var G__39888 = cljs.core.next.call(null,s);
var G__39889 = cljs.core.conj_BANG_.call(null,cljs.core.conj_BANG_.call(null,key_vals,cljs.core.key.call(null,e)),cljs.core.val.call(null,e));
s = G__39888;
key_vals = G__39889;
continue;
} else {
...
var gensym_env39893 = cljs.tools.reader.gensym_env;
...
}finally {cljs.tools.reader.gensym_env = gensym_env39893;
}});
...
var temp__5455__auto__ = ((cljs.core._EQ_.call(null,token,":"))?cljs.core.ns_name.call(null,cljs.core._STAR_ns_STAR_):((cljs.core._EQ_.call(null,":",cljs.core.first.call(null,token)))?(function (){var G__39894 = token;
var G__39894__$1 = (((G__39894 == null))?null:cljs.core.subs.call(null,G__39894,(1)));
var G__39894__$2 = (((G__39894__$1 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__39894__$1));
var G__39894__$3 = (((G__39894__$2 == null))?null:cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__39894__$2));
var G__39894__$4 = (((G__39894__$3 == null))?null:cljs.core.symbol.call(null,G__39894__$3));
if((G__39894__$4 == null)){
return null;
} else {
return cljs.tools.reader.resolve_ns.call(null,G__39894__$4);
}
})():(function (){var G__39895 = token;
var G__39895__$1 = (((G__39895 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__39895));
if((G__39895__$1 == null)){
return null;
} else {
return cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__39895__$1);
}
})()
));
if(cljs.core.truth_(temp__5455__auto__)){
...
}catch (e39902){if((e39902 instanceof Error)){
var e = e39902;
...
cljs.tools.reader.read.cljs$core$IFn$_invoke$arity$2 = (function (p__39906,reader){
var map__39907 = p__39906;
var map__39907__$1 = ((((!((map__39907 == null)))?(((((map__39907.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__39907.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__39907):map__39907);
var opts = map__39907__$1;
var eof = cljs.core.get.call(null,map__39907__$1,new cljs.core.Keyword(null,"eof","eof",-489063237),new cljs.core.Keyword(null,"eofthrow","eofthrow",-334166531));
...
var len__4517__auto___39915 = arguments.length;
var i__4518__auto___39916 = (0);
while(true){
if((i__4518__auto___39916 < len__4517__auto___39915)){
args__4520__auto__.push((arguments[i__4518__auto___39916]));

var G__39917 = (i__4518__auto___39916 + (1));
i__4518__auto___39916 = G__39917;
continue;
} else {
}
break;
...
/** @this {Function} */
cljs.tools.reader.read_PLUS_string.cljs$lang$applyTo = (function (seq39913){
...
return self__4504__auto__.cljs$core$IFn$_invoke$arity$variadic(G__39914,seq39913__$1);
});


//# sourceMappingURL=reader.js.map?rel=1553997018830
