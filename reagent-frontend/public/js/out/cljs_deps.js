...
goog.addDependency("../views/radio.js", ['views.radio'], ['views.helpers', 'frontend.state', 'cljs.core']);
goog.addDependency("../views/home.js", ['views.home'], ['cljs.core']);
goog.addDependency("../logger/core.js", ['logger.core'], ['cljs.core']);
goog.addDependency("../views/music.js", ['views.music'], ['views.helpers', 'reagent.core', 'frontend.state', 'cljs.core', 'frontend.helpers', 'logger.core']);
...
goog.addDependency("../frontend/history.js", ['frontend.history'], ['goog.Uri', 'cljs.core', 'goog.history.EventType', 'accountant.core', 'goog.history.Html5History', 'secretary.core', 'goog.events']);
...
goog.addDependency("../views/sonos.js", ['views.sonos'], ['views.helpers', 'reagent.core', 'frontend.state', 'cljs.core', 'oops.core', 'frontend.helpers', 'jayq.core', 'clojure.string']);
...
goog.addDependency("../frontend/routes.js", ['frontend.routes'], ['views.blog', 'reagent.core', 'frontend.state', 'goog.Uri', 'cljs.core', 'goog.history.EventType', 'views.about', 'views.radio', 'views.home', 'goog.history.Html5History', 'views.music', 'frontend.history', 'secretary.core', 'views.music_single', 'clojure.string', 'goog.events']);
goog.addDependency("../views/header.js", ['views.header'], ['cljs.core', 'views.sonos']);
goog.addDependency("../frontend/core.js", ['frontend.core'], ['frontend.routes', 'views.header', 'reagent.core', 'frontend.state', 'goog.Uri', 'cljs.core', 'oops.core', 'views.sonos', 'goog.history.Html5History', 'secretary.core']);
...
goog.addDependency("../reagent_frontend/dev.js", ['reagent_frontend.dev'], ['cljs.core', 'frontend.core', 'devtools.core']);
