...
var G__55015 = cljs.core.first.call(null,element_str);
switch (G__55015) {
case "?":
arr.push((1));
...
var G__55017 = cljs.core.next.call(null,items);
items = G__55017;
continue;
} else {
return null;
...
var G__55018 = cljs.core.next.call(null,items);
items = G__55018;
continue;
} else {
return null;
...
var G__55020 = cljs.core.next.call(null,cljs.core.next.call(null,items));
items = G__55020;
continue;
} else {
return true;
...
switch (G__55023) {
case (0):
if(cljs.core.truth_(oops.schema.has_invalid_path_access_mode_QMARK_.call(null,path,((function (G__55023){
return (function (p1__55021_SHARP_){
return cljs.core.not_EQ_.call(null,p1__55021_SHARP_,(2));
});})(G__55023))
))){
...
return cljs.core.not_EQ_.call(null,p1__55022_SHARP_,(1));
});})(G__55023))
))){
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__55023)].join('')));

}
}
});

//# sourceMappingURL=schema.js.map?rel=1574224104465
