...
var G__35871 = cljs.core.first.call(null,element_str);
switch (G__35871) {
case "?":
arr.push((1));
...
var G__35873 = cljs.core.next.call(null,items);
items = G__35873;
continue;
} else {
return null;
...
var G__35874 = cljs.core.next.call(null,items);
items = G__35874;
continue;
} else {
return null;
...
var G__35876 = cljs.core.next.call(null,cljs.core.next.call(null,items));
items = G__35876;
continue;
} else {
return true;
...
switch (G__35879) {
case (0):
if(cljs.core.truth_(oops.schema.has_invalid_path_access_mode_QMARK_.call(null,path,((function (G__35879){
return (function (p1__35877_SHARP_){
return cljs.core.not_EQ_.call(null,p1__35877_SHARP_,(2));
});})(G__35879))
))){
...
case (1):
if(cljs.core.truth_(oops.schema.has_invalid_path_access_mode_QMARK_.call(null,path,((function (G__35879){
return (function (p1__35878_SHARP_){
return cljs.core.not_EQ_.call(null,p1__35878_SHARP_,(1));
});})(G__35879))
))){
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__35879)].join('')));

}
}
});

//# sourceMappingURL=schema.js.map?rel=1553576539196
