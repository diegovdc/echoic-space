...
var G__30448 = cljs.core.first.call(null,element_str);
switch (G__30448) {
case "?":
arr.push((1));
...
var G__30450 = cljs.core.next.call(null,items);
items = G__30450;
continue;
} else {
return null;
...
var G__30451 = cljs.core.next.call(null,items);
items = G__30451;
continue;
} else {
return null;
...
var G__30453 = cljs.core.next.call(null,cljs.core.next.call(null,items));
items = G__30453;
continue;
} else {
return true;
...
switch (G__30456) {
case (0):
if(cljs.core.truth_(oops.schema.has_invalid_path_access_mode_QMARK_.call(null,path,((function (G__30456){
return (function (p1__30454_SHARP_){
return cljs.core.not_EQ_.call(null,p1__30454_SHARP_,(2));
});})(G__30456))
))){
...
return cljs.core.not_EQ_.call(null,p1__30455_SHARP_,(1));
});})(G__30456))
))){
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__30456)].join('')));

}
}
});

//# sourceMappingURL=schema.js.map?rel=1552590660080
