...
var G__40817 = cljs.core.first.call(null,element_str);
switch (G__40817) {
case "?":
arr.push((1));
...
var G__40819 = cljs.core.next.call(null,items);
items = G__40819;
continue;
} else {
return null;
...
var G__40820 = cljs.core.next.call(null,items);
items = G__40820;
continue;
} else {
return null;
...
var G__40822 = cljs.core.next.call(null,cljs.core.next.call(null,items));
items = G__40822;
continue;
} else {
return true;
...
switch (G__40825) {
case (0):
if(cljs.core.truth_(oops.schema.has_invalid_path_access_mode_QMARK_.call(null,path,((function (G__40825){
return (function (p1__40823_SHARP_){
return cljs.core.not_EQ_.call(null,p1__40823_SHARP_,(2));
});})(G__40825))
))){
...
return cljs.core.not_EQ_.call(null,p1__40824_SHARP_,(1));
});})(G__40825))
))){
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__40825)].join('')));

}
}
});

//# sourceMappingURL=schema.js.map?rel=1553997021435
