...
var G__47601 = cljs.core.first.call(null,element_str);
switch (G__47601) {
case "?":
arr.push((1));
...
var G__47603 = cljs.core.next.call(null,items);
items = G__47603;
continue;
} else {
return null;
...
var G__47604 = cljs.core.next.call(null,items);
items = G__47604;
continue;
} else {
return null;
...
var G__47606 = cljs.core.next.call(null,cljs.core.next.call(null,items));
items = G__47606;
continue;
} else {
return true;
...
switch (G__47609) {
case (0):
if(cljs.core.truth_(oops.schema.has_invalid_path_access_mode_QMARK_.call(null,path,((function (G__47609){
return (function (p1__47607_SHARP_){
return cljs.core.not_EQ_.call(null,p1__47607_SHARP_,(2));
});})(G__47609))
))){
...
return cljs.core.not_EQ_.call(null,p1__47608_SHARP_,(1));
});})(G__47609))
))){
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__47609)].join('')));

}
}
});

//# sourceMappingURL=schema.js.map?rel=1552956584252
