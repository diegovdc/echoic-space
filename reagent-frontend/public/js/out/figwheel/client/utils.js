...
return (new CustomEvent(event_name,(function (){var obj58239 = {"detail":data};
return obj58239;
})()));
} else {
...
var f = (function (){var pred__58246 = cljs.core._EQ_;
var expr__58247 = (cljs.core.truth_(figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__58246.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__58247))){
return ((function (pred__58246,expr__58247){
return (function (p1__58240_SHARP_){
return console.warn(p1__58240_SHARP_);
});
;})(pred__58246,expr__58247))
} else {
if(cljs.core.truth_(pred__58246.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__58247))){
return ((function (pred__58246,expr__58247){
return (function (p1__58241_SHARP_){
return console.debug(p1__58241_SHARP_);
});
;})(pred__58246,expr__58247))
} else {
if(cljs.core.truth_(pred__58246.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__58247))){
return ((function (pred__58246,expr__58247){
return (function (p1__58242_SHARP_){
return console.error(p1__58242_SHARP_);
});
;})(pred__58246,expr__58247))
} else {
return ((function (pred__58246,expr__58247){
return (function (p1__58243_SHARP_){
return console.log(p1__58243_SHARP_);
});
;})(pred__58246,expr__58247))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__58250){
...
var opts = map__58251__$1;
var eval_fn = cljs.core.get.call(null,map__58251__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__58253_SHARP_);
});})(new_def))
);
...
return (function (p__58254){
var vec__58255 = p__58254;
var ky = cljs.core.nth.call(null,vec__58255,(0),null);
var v = cljs.core.nth.call(null,vec__58255,(1),null);
...
}catch (e58260){if((e58260 instanceof Error)){
var e = e58260;
return not_found;
} else {
throw e58260;
...
//# sourceMappingURL=utils.js.map?rel=1574224107001
