...
return (new CustomEvent(event_name,(function (){var obj45592 = {"detail":data};
return obj45592;
})()));
} else {
...
var f = (function (){var pred__45599 = cljs.core._EQ_;
var expr__45600 = (cljs.core.truth_(figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__45599.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__45600))){
return ((function (pred__45599,expr__45600){
return (function (p1__45593_SHARP_){
return console.warn(p1__45593_SHARP_);
});
;})(pred__45599,expr__45600))
} else {
if(cljs.core.truth_(pred__45599.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__45600))){
return ((function (pred__45599,expr__45600){
return (function (p1__45594_SHARP_){
return console.debug(p1__45594_SHARP_);
});
;})(pred__45599,expr__45600))
} else {
if(cljs.core.truth_(pred__45599.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__45600))){
return ((function (pred__45599,expr__45600){
return (function (p1__45595_SHARP_){
return console.error(p1__45595_SHARP_);
});
;})(pred__45599,expr__45600))
} else {
return ((function (pred__45599,expr__45600){
return (function (p1__45596_SHARP_){
return console.log(p1__45596_SHARP_);
});
;})(pred__45599,expr__45600))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__45603){
...
var opts = map__45604__$1;
var eval_fn = cljs.core.get.call(null,map__45604__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return (function (p1__45606_SHARP_){
return new_def.callback(p1__45606_SHARP_);
});})(new_def))
);
...
return (function (p__45607){
var vec__45608 = p__45607;
var ky = cljs.core.nth.call(null,vec__45608,(0),null);
var v = cljs.core.nth.call(null,vec__45608,(1),null);
...
//# sourceMappingURL=utils.js.map?rel=1553997027149
