...
return (new CustomEvent(event_name,(function (){var obj30733 = {"detail":data};
return obj30733;
})()));
} else {
...
var f = (function (){var pred__30740 = cljs.core._EQ_;
var expr__30741 = (cljs.core.truth_(figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__30740.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__30741))){
return ((function (pred__30740,expr__30741){
return (function (p1__30734_SHARP_){
return console.warn(p1__30734_SHARP_);
});
;})(pred__30740,expr__30741))
} else {
if(cljs.core.truth_(pred__30740.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__30741))){
return ((function (pred__30740,expr__30741){
return (function (p1__30735_SHARP_){
return console.debug(p1__30735_SHARP_);
});
;})(pred__30740,expr__30741))
} else {
if(cljs.core.truth_(pred__30740.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__30741))){
return ((function (pred__30740,expr__30741){
return (function (p1__30736_SHARP_){
return console.error(p1__30736_SHARP_);
});
;})(pred__30740,expr__30741))
} else {
return ((function (pred__30740,expr__30741){
return (function (p1__30737_SHARP_){
return console.log(p1__30737_SHARP_);
});
;})(pred__30740,expr__30741))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__30744){
...
var eval_fn = cljs.core.get.call(null,map__30745__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__30747_SHARP_);
});})(new_def))
);
...
return (function (p__30748){
var vec__30749 = p__30748;
var ky = cljs.core.nth.call(null,vec__30749,(0),null);
var v = cljs.core.nth.call(null,vec__30749,(1),null);
...
}catch (e30754){if((e30754 instanceof Error)){
var e = e30754;
return not_found;
} else {
throw e30754;
...
//# sourceMappingURL=utils.js.map?rel=1553577424340
