...
var len__4517__auto___52353 = arguments.length;
var i__4518__auto___52354 = (0);
while(true){
if((i__4518__auto___52354 < len__4517__auto___52353)){
args__4520__auto__.push((arguments[i__4518__auto___52354]));

var G__52355 = (i__4518__auto___52354 + (1));
i__4518__auto___52354 = G__52355;
continue;
} else {
}
break;
...
/** @this {Function} */
devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq52350){
...
return self__4504__auto__.cljs$core$IFn$_invoke$arity$variadic(G__52351,G__52352,seq52350__$2);
});
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__52356_SHARP_){
return !((cljs.core.meta.call(null,p1__52356_SHARP_) == null));
})))){
...
var markup_db = cljs.core.get.call(null,map__52357__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e52361){var _e__34108__auto__ = e52361;
return false;
}})();
if(cljs.core.truth_(or__3936__auto__)){
return or__3936__auto__;
...
}catch (e52363){var _e__34108__auto__ = e52363;
return false;
}}
})())){
...
var _STAR_current_state_STAR_52365 = devtools.formatters.state._STAR_current_state_STAR_;
devtools.formatters.state._STAR_current_state_STAR_ = devtools.formatters.state.get_current_state.call(null);

try{var map__52366 = opts;
var map__52366__$1 = ((((!((map__52366 == null)))?(((((map__52366.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__52366.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__52366):map__52366);
var markup_db = cljs.core.get.call(null,map__52366__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR_52365;
}});
...
;
var temp__5455__auto___52370 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__5455__auto___52370)){
var managed_print_level_52371 = temp__5455__auto___52370;
var _STAR_print_level_STAR_52369_52372 = cljs.core._STAR_print_level_STAR_;
cljs.core._STAR_print_level_STAR_ = managed_print_level_52371;

try{devtools.formatters.state.update_current_state_BANG_.call(null,((function (_STAR_print_level_STAR_52369_52372,managed_print_level_52371,temp__5455__auto___52370,writer,opts,job_fn){
return (function (p1__52368_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__52368_SHARP_,null);
});})(_STAR_print_level_STAR_52369_52372,managed_print_level_52371,temp__5455__auto___52370,writer,opts,job_fn))
);

job_fn.call(null);
}finally {cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR_52369_52372;
}} else {
job_fn.call(null);
}
...
//# sourceMappingURL=printing.js.map?rel=1574224100579
