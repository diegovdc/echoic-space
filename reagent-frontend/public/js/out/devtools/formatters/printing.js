...
var len__4517__auto___45614 = arguments.length;
var i__4518__auto___45615 = (0);
while(true){
if((i__4518__auto___45615 < len__4517__auto___45614)){
args__4520__auto__.push((arguments[i__4518__auto___45615]));

var G__45616 = (i__4518__auto___45615 + (1));
i__4518__auto___45615 = G__45616;
continue;
} else {
}
break;
...
return devtools.formatters.printing.build_markup.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__4521__auto__);
});
...
/** @this {Function} */
devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq45611){
var G__45612 = cljs.core.first.call(null,seq45611);
var seq45611__$1 = cljs.core.next.call(null,seq45611);
var G__45613 = cljs.core.first.call(null,seq45611__$1);
var seq45611__$2 = cljs.core.next.call(null,seq45611__$1);
var self__4504__auto__ = this;
return self__4504__auto__.cljs$core$IFn$_invoke$arity$variadic(G__45612,G__45613,seq45611__$2);
});
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__45617_SHARP_){
return !((cljs.core.meta.call(null,p1__45617_SHARP_) == null));
})))){
...
var map__45618 = opts;
var map__45618__$1 = ((((!((map__45618 == null)))?(((((map__45618.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__45618.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__45618):map__45618);
var markup_db = cljs.core.get.call(null,map__45618__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e45622){var _e__34118__auto__ = e45622;
return false;
}})();
if(cljs.core.truth_(or__3936__auto__)){
return or__3936__auto__;
...
}catch (e45624){var _e__34118__auto__ = e45624;
return false;
}}
})())){
...
var _STAR_current_state_STAR_45626 = devtools.formatters.state._STAR_current_state_STAR_;
devtools.formatters.state._STAR_current_state_STAR_ = devtools.formatters.state.get_current_state.call(null);

try{var map__45627 = opts;
...
var markup_db = cljs.core.get.call(null,map__45627__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR_45626;
}});
...
;
var temp__5455__auto___45631 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__5455__auto___45631)){
var managed_print_level_45632 = temp__5455__auto___45631;
var _STAR_print_level_STAR_45630_45633 = cljs.core._STAR_print_level_STAR_;
cljs.core._STAR_print_level_STAR_ = managed_print_level_45632;

try{devtools.formatters.state.update_current_state_BANG_.call(null,((function (_STAR_print_level_STAR_45630_45633,managed_print_level_45632,temp__5455__auto___45631,writer,opts,job_fn){
return (function (p1__45629_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__45629_SHARP_,null);
});})(_STAR_print_level_STAR_45630_45633,managed_print_level_45632,temp__5455__auto___45631,writer,opts,job_fn))
);

job_fn.call(null);
}finally {cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR_45630_45633;
}} else {
job_fn.call(null);
}
...
//# sourceMappingURL=printing.js.map?rel=1552956575525
