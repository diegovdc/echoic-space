...
var o45483 = temp__5455__auto__;
var temp__5455__auto____$1 = (o45483["core"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o45484 = temp__5455__auto____$1;
return (o45484["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__34111__auto__ = f;
return (o__34111__auto__["toString"]).call(o__34111__auto__);
} else {
return "";
}
}catch (e45485){var _ = e45485;
return "";
}});
...
try{var o__34111__auto___45487 = t;
(o__34111__auto___45487["cljs$lang$ctorPrWriter"]).call(o__34111__auto___45487,t,writer);
}catch (e45486){var __45488 = e45486;
}
...
var char_code = (function (){var o__34111__auto__ = (new String(char$));
return (o__34111__auto__["charCodeAt"]).call(o__34111__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__34111__auto__ = String;
return (o__34111__auto__["fromCharCode"]).call(o__34111__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__45489 = num_code;
switch (G__45489) {
case (1):
return (185);
...
var o__34111__auto__ = String;
return (o__34111__auto__["fromCharCode"]).call(o__34111__auto__,superscript_code);
});
/**
...
}catch (e45491){var _e__34118__auto__ = e45491;
return false;
}})())){
...
var vec__45492 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__45492,(0),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var o45495 = temp__5455__auto__;
var temp__5455__auto____$1 = (o45495["dependencies_"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o45496 = temp__5455__auto____$1;
return (o45496["nameToPath"]);
} else {
return null;
}
} else {
...
var len__4517__auto___45503 = arguments.length;
var i__4518__auto___45504 = (0);
while(true){
if((i__4518__auto___45504 < len__4517__auto___45503)){
args__4520__auto__.push((arguments[i__4518__auto___45504]));

var G__45505 = (i__4518__auto___45504 + (1));
i__4518__auto___45504 = G__45505;
continue;
} else {
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__45499){
var vec__45500 = p__45499;
var ns_detector = cljs.core.nth.call(null,vec__45500,(0),null);
...
var G__45506 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__45507 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__45506;
remaining_tokens = G__45507;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq45497){
...
return self__4504__auto__.cljs$core$IFn$_invoke$arity$variadic(G__45498,seq45497__$1);
});
...
var vec__45511 = cljs.core.split_with.call(null,(function (p1__45510_SHARP_){
return cljs.core.not_EQ_.call(null,p1__45510_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__45511,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__45511,(1),null);
...
var vec__45514 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__45514,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__45514,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__45517 = cljs.core.rest.call(null,remaining_tokens);
var G__45518 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__45517;
name_tokens = G__45518;
continue;
} else {
...
var vec__45521 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__45521,(0),null);
var arity = cljs.core.nth.call(null,vec__45521,(1),null);
var vec__45524 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__45524,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__45524,(1),null);
var vec__45527 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__45527,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__45527,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__45527,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__45527,(3),null);
...
var vec__45533 = result;
var munged_ns = cljs.core.nth.call(null,vec__45533,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__45533,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__45533,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__45533,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__45533,(4),null);
var arity = cljs.core.nth.call(null,vec__45533,(5),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var vec__45537 = temp__5455__auto__;
var munged_name = cljs.core.nth.call(null,vec__45537,(0),null);
var args = cljs.core.nth.call(null,vec__45537,(1),null);
var vec__45540 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__45540,(0),null);
var name = cljs.core.nth.call(null,vec__45540,(1),null);
...
var G__45543 = (arity + (1));
var G__45544 = (function (){var temp__5455__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5455__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__45545){
var vec__45546 = p__45545;
var arity = cljs.core.nth.call(null,vec__45546,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__45546,(1),null);
...
return cljs.core.get.call(null,arities,p1__45549_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__45550_SHARP_);
...
var args__4520__auto__ = [];
var len__4517__auto___45557 = arguments.length;
var i__4518__auto___45558 = (0);
while(true){
if((i__4518__auto___45558 < len__4517__auto___45557)){
args__4520__auto__.push((arguments[i__4518__auto___45558]));

var G__45559 = (i__4518__auto___45558 + (1));
i__4518__auto___45558 = G__45559;
continue;
} else {
}
break;
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__45553){
var vec__45554 = p__45553;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__45554,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq45551){
var G__45552 = cljs.core.first.call(null,seq45551);
var seq45551__$1 = cljs.core.next.call(null,seq45551);
var self__4504__auto__ = this;
return self__4504__auto__.cljs$core$IFn$_invoke$arity$variadic(G__45552,seq45551__$1);
});
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__45562__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__45562__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__45562__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__45562__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__45563 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__45563,(0),null);
var fn_name = cljs.core.nth.call(null,vec__45563,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__45563,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__45563,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__45563,(4),null);
var arity = cljs.core.nth.call(null,vec__45563,(5),null);
...
var o__34111__auto__ = f;
return (o__34111__auto__["getBasis"]).call(o__34111__auto__);
});
/**
...
}catch (e45567){var _e__34118__auto__ = e45567;
...
var G__45568 = (obj[cljs.core.first.call(null,path)]);
var G__45569 = cljs.core.rest.call(null,path);
obj = G__45568;
path = G__45569;
continue;
} else {
...
return (function (accum,p__45570){
var vec__45571 = p__45570;
var bit = cljs.core.nth.call(null,vec__45571,(0),null);
var protocol = cljs.core.nth.call(null,vec__45571,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__45574){
var vec__45575 = p__45574;
var ns = cljs.core.nth.call(null,vec__45575,(0),null);
var name = cljs.core.nth.call(null,vec__45575,(1),null);
var selector = cljs.core.nth.call(null,vec__45575,(2),null);
...
return (function (p__45579){
var vec__45580 = p__45579;
var munged_name = cljs.core.nth.call(null,vec__45580,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__45580,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__45580,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__45578_SHARP_){
return (obj[cljs.core.first.call(null,p1__45578_SHARP_)]);
});})(name,sorted_matches,vec__45580,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1552956574744
