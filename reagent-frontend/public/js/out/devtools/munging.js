...
var o32939 = temp__5455__auto__;
var temp__5455__auto____$1 = (o32939["core"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o32940 = temp__5455__auto____$1;
return (o32940["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__32270__auto__ = f;
return (o__32270__auto__["toString"]).call(o__32270__auto__);
} else {
return "";
}
}catch (e32941){var _ = e32941;
return "";
}});
...
try{var o__32270__auto___32943 = t;
(o__32270__auto___32943["cljs$lang$ctorPrWriter"]).call(o__32270__auto___32943,t,writer);
}catch (e32942){var __32944 = e32942;
}
...
var char_code = (function (){var o__32270__auto__ = (new String(char$));
return (o__32270__auto__["charCodeAt"]).call(o__32270__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__32270__auto__ = String;
return (o__32270__auto__["fromCharCode"]).call(o__32270__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__32945 = num_code;
switch (G__32945) {
case (1):
return (185);
...
var o__32270__auto__ = String;
return (o__32270__auto__["fromCharCode"]).call(o__32270__auto__,superscript_code);
});
/**
...
}catch (e32947){var _e__32277__auto__ = e32947;
return false;
}})())){
...
var vec__32948 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__32948,(0),null);
...
var or__3936__auto__ = (function (){var temp__5455__auto__ = cljs.core.re_matches.call(null,/(.*)\$/,s);
if(cljs.core.truth_(temp__5455__auto__)){
...
if(cljs.core.truth_(temp__5455__auto__)){
var o32951 = temp__5455__auto__;
var temp__5455__auto____$1 = (o32951["dependencies_"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o32952 = temp__5455__auto____$1;
return (o32952["nameToPath"]);
} else {
return null;
}
} else {
...
var len__4517__auto___32959 = arguments.length;
var i__4518__auto___32960 = (0);
while(true){
if((i__4518__auto___32960 < len__4517__auto___32959)){
args__4520__auto__.push((arguments[i__4518__auto___32960]));

var G__32961 = (i__4518__auto___32960 + (1));
i__4518__auto___32960 = G__32961;
continue;
} else {
}
break;
...
return devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__4521__auto__);
});

devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__32955){
var vec__32956 = p__32955;
var ns_detector = cljs.core.nth.call(null,vec__32956,(0),null);
...
var G__32962 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__32963 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__32962;
remaining_tokens = G__32963;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq32953){
...
return self__4504__auto__.cljs$core$IFn$_invoke$arity$variadic(G__32954,seq32953__$1);
});
...
var vec__32967 = cljs.core.split_with.call(null,(function (p1__32966_SHARP_){
return cljs.core.not_EQ_.call(null,p1__32966_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__32967,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__32967,(1),null);
...
var vec__32970 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__32970,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__32970,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__32973 = cljs.core.rest.call(null,remaining_tokens);
var G__32974 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__32973;
name_tokens = G__32974;
continue;
} else {
...
var vec__32977 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__32977,(0),null);
var arity = cljs.core.nth.call(null,vec__32977,(1),null);
var vec__32980 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__32980,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__32980,(1),null);
var vec__32983 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__32983,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__32983,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__32983,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__32983,(3),null);
...
var vec__32989 = result;
var munged_ns = cljs.core.nth.call(null,vec__32989,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__32989,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__32989,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__32989,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__32989,(4),null);
var arity = cljs.core.nth.call(null,vec__32989,(5),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var vec__32993 = temp__5455__auto__;
var munged_name = cljs.core.nth.call(null,vec__32993,(0),null);
var args = cljs.core.nth.call(null,vec__32993,(1),null);
var vec__32996 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__32996,(0),null);
var name = cljs.core.nth.call(null,vec__32996,(1),null);
...
var G__32999 = (arity + (1));
var G__33000 = (function (){var temp__5455__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5455__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__33001){
var vec__33002 = p__33001;
var arity = cljs.core.nth.call(null,vec__33002,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__33002,(1),null);
...
return cljs.core.get.call(null,arities,p1__33005_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return (function (p1__33006_SHARP_){
return cljs.core.drop.call(null,(2),p1__33006_SHARP_);
...
var args__4520__auto__ = [];
var len__4517__auto___33013 = arguments.length;
var i__4518__auto___33014 = (0);
while(true){
if((i__4518__auto___33014 < len__4517__auto___33013)){
args__4520__auto__.push((arguments[i__4518__auto___33014]));

var G__33015 = (i__4518__auto___33014 + (1));
i__4518__auto___33014 = G__33015;
continue;
} else {
}
break;
...
var argseq__4521__auto__ = ((((1) < args__4520__auto__.length))?(new cljs.core.IndexedSeq(args__4520__auto__.slice((1)),(0),null)):null);
return devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__4521__auto__);
});

devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__33009){
var vec__33010 = p__33009;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__33010,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq33007){
var G__33008 = cljs.core.first.call(null,seq33007);
var seq33007__$1 = cljs.core.next.call(null,seq33007);
var self__4504__auto__ = this;
return self__4504__auto__.cljs$core$IFn$_invoke$arity$variadic(G__33008,seq33007__$1);
});
...
var G__33016 = arg;
var G__33016__$1 = (((G__33016 instanceof cljs.core.Keyword))?G__33016.fqn:null);
switch (G__33016__$1) {
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__33018__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__33018__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__33018__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__33018__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__33019 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__33019,(0),null);
var fn_name = cljs.core.nth.call(null,vec__33019,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__33019,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__33019,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__33019,(4),null);
var arity = cljs.core.nth.call(null,vec__33019,(5),null);
...
var o__32270__auto__ = f;
return (o__32270__auto__["getBasis"]).call(o__32270__auto__);
});
/**
...
}catch (e33023){var _e__32277__auto__ = e33023;
...
var G__33024 = (obj[cljs.core.first.call(null,path)]);
var G__33025 = cljs.core.rest.call(null,path);
obj = G__33024;
path = G__33025;
continue;
} else {
...
return (function (accum,p__33026){
var vec__33027 = p__33026;
var bit = cljs.core.nth.call(null,vec__33027,(0),null);
var protocol = cljs.core.nth.call(null,vec__33027,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__33030){
var vec__33031 = p__33030;
var ns = cljs.core.nth.call(null,vec__33031,(0),null);
var name = cljs.core.nth.call(null,vec__33031,(1),null);
var selector = cljs.core.nth.call(null,vec__33031,(2),null);
...
return (function (p__33035){
var vec__33036 = p__33035;
var munged_name = cljs.core.nth.call(null,vec__33036,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__33036,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__33036,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__33034_SHARP_){
return (obj[cljs.core.first.call(null,p1__33034_SHARP_)]);
});})(name,sorted_matches,vec__33036,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1553576527941
