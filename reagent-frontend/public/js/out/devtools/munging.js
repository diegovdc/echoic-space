...
var o27675 = temp__5455__auto__;
var temp__5455__auto____$1 = (o27675["core"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o27676 = temp__5455__auto____$1;
return (o27676["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__27006__auto__ = f;
return (o__27006__auto__["toString"]).call(o__27006__auto__);
} else {
return "";
}
}catch (e27677){var _ = e27677;
return "";
}});
...
try{var o__27006__auto___27679 = t;
(o__27006__auto___27679["cljs$lang$ctorPrWriter"]).call(o__27006__auto___27679,t,writer);
}catch (e27678){var __27680 = e27678;
}
...
var char_code = (function (){var o__27006__auto__ = (new String(char$));
return (o__27006__auto__["charCodeAt"]).call(o__27006__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__27006__auto__ = String;
return (o__27006__auto__["fromCharCode"]).call(o__27006__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__27681 = num_code;
switch (G__27681) {
case (1):
return (185);
...
var o__27006__auto__ = String;
return (o__27006__auto__["fromCharCode"]).call(o__27006__auto__,superscript_code);
});
/**
...
}catch (e27683){var _e__27013__auto__ = e27683;
return false;
}})())){
...
var vec__27684 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__27684,(0),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var o27687 = temp__5455__auto__;
var temp__5455__auto____$1 = (o27687["dependencies_"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o27688 = temp__5455__auto____$1;
return (o27688["nameToPath"]);
} else {
return null;
}
} else {
...
var len__4517__auto___27695 = arguments.length;
var i__4518__auto___27696 = (0);
while(true){
if((i__4518__auto___27696 < len__4517__auto___27695)){
args__4520__auto__.push((arguments[i__4518__auto___27696]));

var G__27697 = (i__4518__auto___27696 + (1));
i__4518__auto___27696 = G__27697;
continue;
} else {
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__27691){
var vec__27692 = p__27691;
var ns_detector = cljs.core.nth.call(null,vec__27692,(0),null);
...
var G__27698 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__27699 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__27698;
remaining_tokens = G__27699;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq27689){
...
return self__4504__auto__.cljs$core$IFn$_invoke$arity$variadic(G__27690,seq27689__$1);
});
...
var vec__27703 = cljs.core.split_with.call(null,(function (p1__27702_SHARP_){
return cljs.core.not_EQ_.call(null,p1__27702_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__27703,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__27703,(1),null);
...
var vec__27706 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__27706,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__27706,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__27709 = cljs.core.rest.call(null,remaining_tokens);
var G__27710 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__27709;
name_tokens = G__27710;
continue;
} else {
...
var vec__27713 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__27713,(0),null);
var arity = cljs.core.nth.call(null,vec__27713,(1),null);
var vec__27716 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__27716,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__27716,(1),null);
var vec__27719 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__27719,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__27719,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__27719,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__27719,(3),null);
...
var vec__27725 = result;
var munged_ns = cljs.core.nth.call(null,vec__27725,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__27725,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__27725,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__27725,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__27725,(4),null);
var arity = cljs.core.nth.call(null,vec__27725,(5),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var vec__27729 = temp__5455__auto__;
var munged_name = cljs.core.nth.call(null,vec__27729,(0),null);
var args = cljs.core.nth.call(null,vec__27729,(1),null);
var vec__27732 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__27732,(0),null);
var name = cljs.core.nth.call(null,vec__27732,(1),null);
...
var G__27735 = (arity + (1));
var G__27736 = (function (){var temp__5455__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5455__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__27737){
var vec__27738 = p__27737;
var arity = cljs.core.nth.call(null,vec__27738,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__27738,(1),null);
...
return cljs.core.get.call(null,arities,p1__27741_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__27742_SHARP_);
...
var args__4520__auto__ = [];
var len__4517__auto___27749 = arguments.length;
var i__4518__auto___27750 = (0);
while(true){
if((i__4518__auto___27750 < len__4517__auto___27749)){
args__4520__auto__.push((arguments[i__4518__auto___27750]));

var G__27751 = (i__4518__auto___27750 + (1));
i__4518__auto___27750 = G__27751;
continue;
} else {
}
break;
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__27745){
var vec__27746 = p__27745;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__27746,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq27743){
var G__27744 = cljs.core.first.call(null,seq27743);
var seq27743__$1 = cljs.core.next.call(null,seq27743);
var self__4504__auto__ = this;
return self__4504__auto__.cljs$core$IFn$_invoke$arity$variadic(G__27744,seq27743__$1);
});
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__27754__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__27754__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__27754__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__27754__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__27755 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__27755,(0),null);
var fn_name = cljs.core.nth.call(null,vec__27755,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__27755,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__27755,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__27755,(4),null);
var arity = cljs.core.nth.call(null,vec__27755,(5),null);
...
var o__27006__auto__ = f;
return (o__27006__auto__["getBasis"]).call(o__27006__auto__);
});
/**
...
}catch (e27759){var _e__27013__auto__ = e27759;
...
var G__27760 = (obj[cljs.core.first.call(null,path)]);
var G__27761 = cljs.core.rest.call(null,path);
obj = G__27760;
path = G__27761;
continue;
} else {
...
return (function (accum,p__27762){
var vec__27763 = p__27762;
var bit = cljs.core.nth.call(null,vec__27763,(0),null);
var protocol = cljs.core.nth.call(null,vec__27763,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__27766){
var vec__27767 = p__27766;
var ns = cljs.core.nth.call(null,vec__27767,(0),null);
var name = cljs.core.nth.call(null,vec__27767,(1),null);
var selector = cljs.core.nth.call(null,vec__27767,(2),null);
...
var munged_name = cljs.core.nth.call(null,vec__27772,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__27772,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__27772,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__27770_SHARP_){
return (obj[cljs.core.first.call(null,p1__27770_SHARP_)]);
});})(name,sorted_matches,vec__27772,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1552590641220
