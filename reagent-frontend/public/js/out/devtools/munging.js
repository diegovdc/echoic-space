...
var o52222 = temp__5455__auto__;
var temp__5455__auto____$1 = (o52222["core"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o52223 = temp__5455__auto____$1;
return (o52223["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__34101__auto__ = f;
return (o__34101__auto__["toString"]).call(o__34101__auto__);
} else {
return "";
}
}catch (e52224){var _ = e52224;
return "";
}});
...
try{var o__34101__auto___52226 = t;
(o__34101__auto___52226["cljs$lang$ctorPrWriter"]).call(o__34101__auto___52226,t,writer);
}catch (e52225){var __52227 = e52225;
}
...
var char_code = (function (){var o__34101__auto__ = (new String(char$));
return (o__34101__auto__["charCodeAt"]).call(o__34101__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__34101__auto__ = String;
return (o__34101__auto__["fromCharCode"]).call(o__34101__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__52228 = num_code;
switch (G__52228) {
case (1):
return (185);
...
var o__34101__auto__ = String;
return (o__34101__auto__["fromCharCode"]).call(o__34101__auto__,superscript_code);
});
/**
...
}catch (e52230){var _e__34108__auto__ = e52230;
return false;
}})())){
...
var vec__52231 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__52231,(0),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var o52234 = temp__5455__auto__;
var temp__5455__auto____$1 = (o52234["dependencies_"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o52235 = temp__5455__auto____$1;
return (o52235["nameToPath"]);
} else {
return null;
}
} else {
...
var len__4517__auto___52242 = arguments.length;
var i__4518__auto___52243 = (0);
while(true){
if((i__4518__auto___52243 < len__4517__auto___52242)){
args__4520__auto__.push((arguments[i__4518__auto___52243]));

var G__52244 = (i__4518__auto___52243 + (1));
i__4518__auto___52243 = G__52244;
continue;
} else {
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__52238){
var vec__52239 = p__52238;
var ns_detector = cljs.core.nth.call(null,vec__52239,(0),null);
...
var G__52245 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__52246 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__52245;
remaining_tokens = G__52246;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq52236){
var G__52237 = cljs.core.first.call(null,seq52236);
var seq52236__$1 = cljs.core.next.call(null,seq52236);
var self__4504__auto__ = this;
return self__4504__auto__.cljs$core$IFn$_invoke$arity$variadic(G__52237,seq52236__$1);
});
...
var vec__52250 = cljs.core.split_with.call(null,(function (p1__52249_SHARP_){
return cljs.core.not_EQ_.call(null,p1__52249_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__52250,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__52250,(1),null);
...
var vec__52253 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__52253,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__52253,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__52256 = cljs.core.rest.call(null,remaining_tokens);
var G__52257 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__52256;
name_tokens = G__52257;
continue;
} else {
...
var vec__52260 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__52260,(0),null);
var arity = cljs.core.nth.call(null,vec__52260,(1),null);
var vec__52263 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__52263,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__52263,(1),null);
var vec__52266 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__52266,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__52266,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__52266,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__52266,(3),null);
...
var vec__52272 = result;
var munged_ns = cljs.core.nth.call(null,vec__52272,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__52272,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__52272,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__52272,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__52272,(4),null);
var arity = cljs.core.nth.call(null,vec__52272,(5),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var vec__52276 = temp__5455__auto__;
var munged_name = cljs.core.nth.call(null,vec__52276,(0),null);
var args = cljs.core.nth.call(null,vec__52276,(1),null);
var vec__52279 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__52279,(0),null);
var name = cljs.core.nth.call(null,vec__52279,(1),null);
...
var G__52282 = (arity + (1));
var G__52283 = (function (){var temp__5455__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5455__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__52284){
var vec__52285 = p__52284;
var arity = cljs.core.nth.call(null,vec__52285,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__52285,(1),null);
...
return cljs.core.get.call(null,arities,p1__52288_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__52289_SHARP_);
...
var args__4520__auto__ = [];
var len__4517__auto___52296 = arguments.length;
var i__4518__auto___52297 = (0);
while(true){
if((i__4518__auto___52297 < len__4517__auto___52296)){
args__4520__auto__.push((arguments[i__4518__auto___52297]));

var G__52298 = (i__4518__auto___52297 + (1));
i__4518__auto___52297 = G__52298;
continue;
} else {
}
break;
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__52292){
var vec__52293 = p__52292;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__52293,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq52290){
var G__52291 = cljs.core.first.call(null,seq52290);
var seq52290__$1 = cljs.core.next.call(null,seq52290);
var self__4504__auto__ = this;
return self__4504__auto__.cljs$core$IFn$_invoke$arity$variadic(G__52291,seq52290__$1);
});
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__52301__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__52301__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__52301__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__52301__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__52302 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__52302,(0),null);
var fn_name = cljs.core.nth.call(null,vec__52302,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__52302,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__52302,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__52302,(4),null);
var arity = cljs.core.nth.call(null,vec__52302,(5),null);
...
var o__34101__auto__ = f;
return (o__34101__auto__["getBasis"]).call(o__34101__auto__);
});
/**
...
}catch (e52306){var _e__34108__auto__ = e52306;
...
var G__52307 = (obj[cljs.core.first.call(null,path)]);
var G__52308 = cljs.core.rest.call(null,path);
obj = G__52307;
path = G__52308;
continue;
} else {
...
return (function (accum,p__52309){
var vec__52310 = p__52309;
var bit = cljs.core.nth.call(null,vec__52310,(0),null);
var protocol = cljs.core.nth.call(null,vec__52310,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__52313){
var vec__52314 = p__52313;
var ns = cljs.core.nth.call(null,vec__52314,(0),null);
var name = cljs.core.nth.call(null,vec__52314,(1),null);
var selector = cljs.core.nth.call(null,vec__52314,(2),null);
...
var munged_name = cljs.core.nth.call(null,vec__52319,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__52319,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__52319,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__52317_SHARP_){
return (obj[cljs.core.first.call(null,p1__52317_SHARP_)]);
});})(name,sorted_matches,vec__52319,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1574224100461
