...
var temp__5455__auto____$1 = (o38033["core"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o38034 = temp__5455__auto____$1;
return (o38034["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__32736__auto__ = f;
return (o__32736__auto__["toString"]).call(o__32736__auto__);
} else {
return "";
}
}catch (e38035){var _ = e38035;
return "";
}});
...
try{var o__32736__auto___38037 = t;
(o__32736__auto___38037["cljs$lang$ctorPrWriter"]).call(o__32736__auto___38037,t,writer);
}catch (e38036){var __38038 = e38036;
}
...
var char_code = (function (){var o__32736__auto__ = (new String(char$));
return (o__32736__auto__["charCodeAt"]).call(o__32736__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__32736__auto__ = String;
return (o__32736__auto__["fromCharCode"]).call(o__32736__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__38039 = num_code;
switch (G__38039) {
case (1):
return (185);
...
var o__32736__auto__ = String;
return (o__32736__auto__["fromCharCode"]).call(o__32736__auto__,superscript_code);
});
/**
...
}catch (e38041){var _e__32743__auto__ = e38041;
return false;
}})())){
...
var vec__38042 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__38042,(0),null);
...
var temp__5455__auto____$1 = (o38045["dependencies_"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o38046 = temp__5455__auto____$1;
return (o38046["nameToPath"]);
} else {
return null;
}
} else {
...
var len__4517__auto___38053 = arguments.length;
var i__4518__auto___38054 = (0);
while(true){
if((i__4518__auto___38054 < len__4517__auto___38053)){
args__4520__auto__.push((arguments[i__4518__auto___38054]));

var G__38055 = (i__4518__auto___38054 + (1));
i__4518__auto___38054 = G__38055;
continue;
} else {
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__38049){
var vec__38050 = p__38049;
var ns_detector = cljs.core.nth.call(null,vec__38050,(0),null);
...
var G__38056 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__38057 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__38056;
remaining_tokens = G__38057;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq38047){
...
return self__4504__auto__.cljs$core$IFn$_invoke$arity$variadic(G__38048,seq38047__$1);
});
...
var vec__38061 = cljs.core.split_with.call(null,(function (p1__38060_SHARP_){
return cljs.core.not_EQ_.call(null,p1__38060_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__38061,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__38061,(1),null);
...
var vec__38064 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__38064,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__38064,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__38067 = cljs.core.rest.call(null,remaining_tokens);
var G__38068 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__38067;
name_tokens = G__38068;
continue;
} else {
...
var vec__38071 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__38071,(0),null);
var arity = cljs.core.nth.call(null,vec__38071,(1),null);
var vec__38074 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__38074,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__38074,(1),null);
var vec__38077 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__38077,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__38077,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__38077,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__38077,(3),null);
...
var vec__38083 = result;
var munged_ns = cljs.core.nth.call(null,vec__38083,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__38083,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__38083,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__38083,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__38083,(4),null);
var arity = cljs.core.nth.call(null,vec__38083,(5),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var vec__38087 = temp__5455__auto__;
var munged_name = cljs.core.nth.call(null,vec__38087,(0),null);
var args = cljs.core.nth.call(null,vec__38087,(1),null);
var vec__38090 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__38090,(0),null);
var name = cljs.core.nth.call(null,vec__38090,(1),null);
...
var G__38093 = (arity + (1));
var G__38094 = (function (){var temp__5455__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5455__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__38095){
var vec__38096 = p__38095;
var arity = cljs.core.nth.call(null,vec__38096,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__38096,(1),null);
...
return cljs.core.get.call(null,arities,p1__38099_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__38100_SHARP_);
...
var args__4520__auto__ = [];
var len__4517__auto___38107 = arguments.length;
var i__4518__auto___38108 = (0);
while(true){
if((i__4518__auto___38108 < len__4517__auto___38107)){
args__4520__auto__.push((arguments[i__4518__auto___38108]));

var G__38109 = (i__4518__auto___38108 + (1));
i__4518__auto___38108 = G__38109;
continue;
} else {
}
break;
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__38103){
var vec__38104 = p__38103;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__38104,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq38101){
var G__38102 = cljs.core.first.call(null,seq38101);
var seq38101__$1 = cljs.core.next.call(null,seq38101);
var self__4504__auto__ = this;
return self__4504__auto__.cljs$core$IFn$_invoke$arity$variadic(G__38102,seq38101__$1);
});
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__38112__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__38112__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__38112__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__38112__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__38113 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__38113,(0),null);
var fn_name = cljs.core.nth.call(null,vec__38113,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__38113,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__38113,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__38113,(4),null);
var arity = cljs.core.nth.call(null,vec__38113,(5),null);
...
var o__32736__auto__ = f;
return (o__32736__auto__["getBasis"]).call(o__32736__auto__);
});
/**
...
}catch (e38117){var _e__32743__auto__ = e38117;
...
var G__38118 = (obj[cljs.core.first.call(null,path)]);
var G__38119 = cljs.core.rest.call(null,path);
obj = G__38118;
path = G__38119;
continue;
} else {
...
return (function (accum,p__38120){
var vec__38121 = p__38120;
var bit = cljs.core.nth.call(null,vec__38121,(0),null);
var protocol = cljs.core.nth.call(null,vec__38121,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__38124){
var vec__38125 = p__38124;
var ns = cljs.core.nth.call(null,vec__38125,(0),null);
var name = cljs.core.nth.call(null,vec__38125,(1),null);
var selector = cljs.core.nth.call(null,vec__38125,(2),null);
...
var munged_name = cljs.core.nth.call(null,vec__38130,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__38130,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__38130,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__38128_SHARP_){
return (obj[cljs.core.first.call(null,p1__38128_SHARP_)]);
});})(name,sorted_matches,vec__38130,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1553997014187
