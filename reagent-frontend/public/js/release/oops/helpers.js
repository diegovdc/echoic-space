...
var G__30269 = cljs.core.next(items);
items = G__30269;
continue;
} else {
return arr;
...
var x30270 = error;
x30270.cljs$core$IPrintWithWriter$ = cljs.core.PROTOCOL_SENTINEL;

x30270.cljs$core$IPrintWithWriter$_pr_writer$arity$3 = ((function (x30270){
...
var G__30271 = Object.getPrototypeOf(o);
o = G__30271;
continue;
} else {
