...
return cljs.core.group_by(frontend.helpers.year,cljs.core.sort.cljs$core$IFn$_invoke$arity$2((function (p1__32216_SHARP_,p2__32215_SHARP_){
return cljs.core.compare(cljs.core.cst$kw$date.cljs$core$IFn$_invoke$arity$1(p2__32215_SHARP_),cljs.core.cst$kw$date.cljs$core$IFn$_invoke$arity$1(p1__32216_SHARP_));
}),entry));
});
...
return cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__32217_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentHashSet.EMPTY,(function (){var G__32218 = selected_categories;
var G__32219 = cljs.core.set(cljs.core.cst$kw$category.cljs$core$IFn$_invoke$arity$1(p1__32217_SHARP_));
return clojure.set.intersection(G__32218,G__32219);
})());
}),entry);
}
});
...
var G__32220 = set;
var G__32221 = cljs.core.PersistentHashSet.createAsIfByAssoc([val]);
return clojure.set.difference(G__32220,G__32221);
} else {
var G__32222 = set;
var G__32223 = cljs.core.PersistentHashSet.createAsIfByAssoc([val]);
return clojure.set.union(G__32222,G__32223);
}
});
frontend.helpers.toggle_category = (function frontend$helpers$toggle_category(selected_categories_atom,cat){
return (function (){
return cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$2(selected_categories_atom,(function (p1__32224_SHARP_){
return frontend.helpers.toggle_in_set(p1__32224_SHARP_,cat);
}));
});
});
...
var fexpr__32225_32226 = frontend.helpers.toggle_category(frontend.helpers.cats,(2));
(fexpr__32225_32226.cljs$core$IFn$_invoke$arity$0 ? fexpr__32225_32226.cljs$core$IFn$_invoke$arity$0() : fexpr__32225_32226.call(null));
