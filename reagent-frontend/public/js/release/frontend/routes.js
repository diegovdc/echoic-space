...
var action__29503__auto___31268 = (function (params__29504__auto__){
if(cljs.core.map_QMARK_(params__29504__auto__)){
var map__31243 = params__29504__auto__;
...
var vec__31245 = params__29504__auto__;
return cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$4(frontend.state.app_state,cljs.core.assoc,cljs.core.cst$kw$page,cljs.core.cst$kw$home);
} else {
return null;
}
...
secretary.core.add_route_BANG_("/",action__29503__auto___31268);
...
secretary.core.add_route_BANG_(/\/about\/?/,action__29503__auto___31269);
...
secretary.core.add_route_BANG_(/\/music\/?/,action__29503__auto___31270);
...
var single = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31258__$1,cljs.core.cst$kw$single);
return frontend.routes.music_single(single);
} else {
if(cljs.core.vector_QMARK_(params__29504__auto__)){
var vec__31260 = params__29504__auto__;
var single = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31260,(0),null);
return frontend.routes.music_single(single);
} else {
return null;
}
...
secretary.core.add_route_BANG_("/music/:single",action__29503__auto___31271);
...
return (function (){
var G__31274 = cljs.core.cst$kw$page;
var fexpr__31273 = cljs.core.deref(frontend.state.app_state);
return (fexpr__31273.cljs$core$IFn$_invoke$arity$1 ? fexpr__31273.cljs$core$IFn$_invoke$arity$1(G__31274) : fexpr__31273.call(null,G__31274));
...
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [views.music_single.main((function (){var G__31276 = cljs.core.cst$kw$single;
var fexpr__31275 = cljs.core.deref(frontend.state.app_state);
return (fexpr__31275.cljs$core$IFn$_invoke$arity$1 ? fexpr__31275.cljs$core$IFn$_invoke$arity$1(G__31276) : fexpr__31275.call(null,G__31276));
})(),(function (){var G__31278 = cljs.core.cst$kw$hash;
var fexpr__31277 = cljs.core.deref(frontend.state.app_state);
