...
var G__29982 = cljs.core.cst$kw$top.cljs$core$IFn$_invoke$arity$1(jayq.core.offset.cljs$core$IFn$_invoke$arity$1(jayq.core.$.cljs$core$IFn$_invoke$arity$1(["#",cljs.core.str.cljs$core$IFn$_invoke$arity$1(id)].join(''))));
var fexpr__29981 = ((function (G__29982){
return (function (p1__29980_SHARP_){
return (p1__29980_SHARP_ - (26));
});})(G__29982))
;
return fexpr__29981(G__29982);
});
...
var G__29986 = cljs.core.cst$kw$is_DASH_playing;
var fexpr__29985 = cljs.core.deref(frontend.state.player_state);
return (fexpr__29985.cljs$core$IFn$_invoke$arity$1 ? fexpr__29985.cljs$core$IFn$_invoke$arity$1(G__29986) : fexpr__29985.call(null,G__29986));
} else {
...
return (function (){
var player = (new YT.Player("player",(function (){var obj29988 = {"videoId":cljs.core.cst$kw$youtube_id.cljs$core$IFn$_invoke$arity$1(post_attrs),"events":(function (){var obj29990 = {"onReady":onPlayerReady};
return obj29990;
})()};
return obj29988;
})()));
...
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(true,(function (){var G__29991 = cljs.core.cst$kw$is_video;
return (post_attrs.cljs$core$IFn$_invoke$arity$1 ? post_attrs.cljs$core$IFn$_invoke$arity$1(G__29991) : post_attrs.call(null,G__29991));
})())){
...
return (function (){
cljs.core.reset_BANG_(local_state,cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.deref(local_state),new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$show_DASH_info,cljs.core.not((function (){var G__29994 = cljs.core.cst$kw$show_DASH_info;
var fexpr__29993 = cljs.core.deref(local_state);
...
return frontend.helpers.scroll_to(((cljs.core.not((function (){var G__29996 = cljs.core.cst$kw$show_DASH_info;
...
})()))?(0):(function (){var G__29998 = cljs.core.cst$kw$top.cljs$core$IFn$_invoke$arity$1(jayq.core.offset.cljs$core$IFn$_invoke$arity$1(jayq.core.$.cljs$core$IFn$_invoke$arity$1(".markdown-body")));
var fexpr__29997 = ((function (G__29998){
return (function (p1__29992_SHARP_){
return (p1__29992_SHARP_ - (26));
});})(G__29998))
;
return fexpr__29997(G__29998);
})()));
}));
});
});
...
return cljs.core.first(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__30001_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(cljs.core.cst$kw$slug.cljs$core$IFn$_invoke$arity$1(cljs.core.cst$kw$attributes.cljs$core$IFn$_invoke$arity$1(p1__30001_SHARP_)),slug);
}),tracks));
});
