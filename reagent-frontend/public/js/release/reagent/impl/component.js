...
if((i < len)){
var k = (ks[i]);
var G__34608 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(m,cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(k),(o[k]));
var G__34609 = (i + (1));
m = G__34608;
i = G__34609;
continue;
...
var temp__5459__auto__ = (p["argv"]);
if((temp__5459__auto__ == null)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,(function (){var G__34610 = (p["children"]);
return (reagent.impl.component.global$module$react.Children.toArray.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.global$module$react.Children.toArray.cljs$core$IFn$_invoke$arity$1(G__34610) : reagent.impl.component.global$module$react.Children.toArray.call(null,G__34610));
})());
} else {
var v = temp__5459__auto__;
...
return ((cljs.core.fn_QMARK_(c)) && (!(((function (){var G__34612 = c;
var G__34612__$1 = (((G__34612 == null))?null:G__34612.prototype);
if((G__34612__$1 == null)){
return null;
} else {
return (G__34612__$1["reagentRender"]);
}
})() == null))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_(c)) && (!(((function (){var G__34614 = c;
var G__34614__$1 = (((G__34614 == null))?null:G__34614.prototype);
if((G__34614__$1 == null)){
return null;
} else {
return (G__34614__$1["render"]);
}
})() == null))));
});
...
var G__34616 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.vector,res,args);
return (reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1(G__34616) : reagent.impl.component.as_element.call(null,G__34616));
};
...
var _STAR_current_component_STAR_34622 = reagent.impl.component._STAR_current_component_STAR_;
...
}finally {reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR_34622;
}});
...
return ((function (G__34623,G__34623__$1){
...
var c = this;
var G__34628_34630 = (c["cljsRatom"]);
if((G__34628_34630 == null)){
} else {
reagent.ratom.dispose_BANG_(G__34628_34630);
}
...
var renders_34632 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$render,cljs.core.cst$kw$reagentRender,cljs.core.cst$kw$componentFunction], null));
var render_fun_34633 = cljs.core.first(cljs.core.vals(renders_34632));
if((cljs.core.count(renders_34632) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_34632))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_34633)){
} else {
throw (new Error(["Assert failed: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(["Expected something callable, not ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_34633], 0)))].join('')),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var name__$1 = (function (){var G__34631 = name;
switch (G__34631) {
case "":
...
var G__34636 = reagent.impl.component.cljsify(body);
return (reagent.impl.component.global$module$create_react_class.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.global$module$create_react_class.cljs$core$IFn$_invoke$arity$1(G__34636) : reagent.impl.component.global$module$create_react_class.call(null,G__34636));
});
reagent.impl.component.fiber_component_path = (function reagent$impl$component$fiber_component_path(fiber){
var name = (function (){var G__34637 = fiber;
var G__34637__$1 = (((G__34637 == null))?null:(G__34637["type"]));
if((G__34637__$1 == null)){
return null;
} else {
return (G__34637__$1["displayName"]);
}
})();
var parent = (function (){var G__34638 = fiber;
if((G__34638 == null)){
return null;
} else {
return (G__34638["return"]);
}
})();
var path = (function (){var G__34639 = parent;
var G__34639__$1 = (((G__34639 == null))?null:(reagent.impl.component.fiber_component_path.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.fiber_component_path.cljs$core$IFn$_invoke$arity$1(G__34639) : reagent.impl.component.fiber_component_path.call(null,G__34639)));
if((G__34639__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__34639__$1)," > "].join('');
}
})();
...
var temp__5455__auto__ = (function (){var or__3936__auto__ = (function (){var G__34641 = c;
if((G__34641 == null)){
return null;
} else {
return (G__34641["_reactInternalFiber"]);
}
})();
if(cljs.core.truth_(or__3936__auto__)){
return or__3936__auto__;
...
return G__34642._reactInternalFiber;
}
}
})();
...
var instance = (function (){var or__3936__auto__ = (function (){var G__34644 = c;
if((G__34644 == null)){
return null;
} else {
return (G__34644["_reactInternalInstance"]);
}
})();
if(cljs.core.truth_(or__3936__auto__)){
return or__3936__auto__;
} else {
var or__3936__auto____$1 = (function (){var G__34646 = c;
if((G__34646 == null)){
return null;
} else {
return G__34646._reactInternalInstance;
}
})();
...
var elem = (function (){var or__3936__auto__ = (function (){var G__34648 = instance;
if((G__34648 == null)){
return null;
} else {
return (G__34648["_currentElement"]);
}
})();
if(cljs.core.truth_(or__3936__auto__)){
return or__3936__auto__;
} else {
var G__34649 = instance;
if((G__34649 == null)){
return null;
} else {
return G__34649._currentElement;
}
}
})();
var name = (function (){var G__34650 = elem;
var G__34650__$1 = (((G__34650 == null))?null:(G__34650["type"]));
if((G__34650__$1 == null)){
return null;
} else {
return (G__34650__$1["displayName"]);
}
})();
var owner = (function (){var or__3936__auto__ = (function (){var G__34652 = elem;
if((G__34652 == null)){
return null;
} else {
return (G__34652["_owner"]);
}
})();
if(cljs.core.truth_(or__3936__auto__)){
return or__3936__auto__;
...
return G__34653._owner;
}
}
})();
var path = (function (){var G__34654 = owner;
var G__34654__$1 = (((G__34654 == null))?null:(reagent.impl.component.component_path.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.component_path.cljs$core$IFn$_invoke$arity$1(G__34654) : reagent.impl.component.component_path.call(null,G__34654)));
if((G__34654__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__34654__$1)," > "].join('');
}
})();
var res = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(path),cljs.core.str.cljs$core$IFn$_invoke$arity$1(name)].join('');
if(cljs.core.empty_QMARK_(res)){
...
var G__34655 = c;
var G__34655__$1 = (((G__34655 == null))?null:G__34655.constructor);
if((G__34655__$1 == null)){
return null;
} else {
return reagent.impl.util.fun_name(G__34655__$1);
}
}
})();
