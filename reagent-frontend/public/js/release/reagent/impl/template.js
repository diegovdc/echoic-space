...
var G__34716 = o;
(G__34716[reagent.impl.template.cached_prop_name(k)] = (reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__34717__delegate = function (args){
...
while (G__34718__i < G__34718__a.length) {G__34718__a[G__34718__i] = arguments[G__34718__i + 0]; ++G__34718__i;}
  args = new cljs.core.IndexedSeq(G__34718__a,0,null);
} 
return G__34717__delegate.call(this,args);};
...
return G__34717__delegate(args);
});
...
var G__34720 = o;
(G__34720[reagent.impl.template.cached_custom_prop_name(k)] = reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__34721__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
...
while (G__34722__i < G__34722__a.length) {G__34722__a[G__34722__i] = arguments[G__34722__i + 0]; ++G__34722__i;}
  args = new cljs.core.IndexedSeq(G__34722__a,0,null);
} 
...
var G__34725 = props;
var G__34725__$1 = ((((!((id == null))) && ((cljs.core.cst$kw$id.cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__34725,cljs.core.cst$kw$id,id):G__34725);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__34725__$1,cljs.core.cst$kw$class,(function (){var old_class = cljs.core.cst$kw$class.cljs$core$IFn$_invoke$arity$1(props);
if((old_class == null)){
return class$;
} else {
...
reagent.impl.template.stringify_class = (function reagent$impl$template$stringify_class(p__34726){
...
var props = map__34727__$1;
var class$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34727__$1,cljs.core.cst$kw$class);
if(cljs.core.coll_QMARK_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(props,cljs.core.cst$kw$class,clojure.string.join.cljs$core$IFn$_invoke$arity$2(" ",cljs.core.keep.cljs$core$IFn$_invoke$arity$2(((function (map__34727,map__34727__$1,props,class$){
return (function (c){
...
});})(map__34727,map__34727__$1,props,class$))
,class$)));
} else {
return props;
}
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__34729){
...
var on_write = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34730__$1,cljs.core.cst$kw$on_DASH_write);
...
return reagent.impl.batching.do_after_render(((function (node_value,map__34730,map__34730__$1,on_write){
return (function (){
...
});})(node_value,map__34730,map__34730__$1,on_write))
);
} else {
...
var G__34733 = jsprops;
(G__34733["defaultValue"] = value);

(G__34733["onChange"] = ((function (G__34733,v,value,on_change){
return (function (p1__34732_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__34732_SHARP_);
});})(G__34733,v,value,on_change))
);
...
var vec__34736 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34736,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34736,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34736,(2),null);
...
var jsprops = ({"argv": v});
var temp__5461__auto___34740 = reagent.impl.template.key_from_vec(v);
if((temp__5461__auto___34740 == null)){
} else {
var key_34741 = temp__5461__auto___34740;
(jsprops["key"] = key_34741);
}
...
var temp__5461__auto___34742 = reagent.impl.template.key_from_vec(argv);
if((temp__5461__auto___34742 == null)){
} else {
var key_34743 = temp__5461__auto___34742;
reagent.impl.template.oset(jsprops,"key",key_34743);
}
...
var G__34744 = reagent.impl.template.__GT_NativeWrapper();
(G__34744["name"] = c);
...
var G__34745 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,comp,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__34745) : reagent.impl.template.as_element.call(null,G__34745));
} else {
...
var len__4517__auto___34750 = arguments.length;
var i__4518__auto___34751 = (0);
while(true){
if((i__4518__auto___34751 < len__4517__auto___34750)){
args__4520__auto__.push((arguments[i__4518__auto___34751]));

var G__34752 = (i__4518__auto___34751 + (1));
i__4518__auto___34751 = G__34752;
continue;
} else {
}
break;
...
/** @this {Function} */
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq34748){
var G__34749 = cljs.core.first(seq34748);
var seq34748__$1 = cljs.core.next(seq34748);
var self__4504__auto__ = this;
return self__4504__auto__.cljs$core$IFn$_invoke$arity$variadic(G__34749,seq34748__$1);
});
...
break;
default:
var G__34755 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
v = G__34755;
continue;
...
var n__4394__auto___34757 = a.length;
var i_34758 = (0);
while(true){
if((i_34758 < n__4394__auto___34757)){
(a[i_34758] = reagent.impl.template.as_element((a[i_34758])));

var G__34759 = (i_34758 + (1));
i_34758 = G__34759;
continue;
} else {
}
...
var a = cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(s);
var n__4394__auto___34760 = a.length;
var i_34761 = (0);
while(true){
if((i_34761 < n__4394__auto___34760)){
var val_34762 = (a[i_34761]);
if(((cljs.core.vector_QMARK_(val_34762)) && ((reagent.impl.template.key_from_vec(val_34762) == null)))){
(o["no-key"] = true);
} else {
}

(a[i_34761] = reagent.impl.template.as_element(val_34762));
...
var ctx = ({});
var vec__34764 = reagent.ratom.check_derefs(((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
});})(ctx))
);
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34764,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34764,(1),null);
...
var G__34767 = (cljs.core.count(argv) - first_child);
switch (G__34767) {
case (0):
...
case (1):
var G__34768 = comp;
var G__34769 = jsprops;
var G__34770 = reagent.impl.template.as_element(cljs.core.nth.cljs$core$IFn$_invoke$arity$3(argv,first_child,null));
return (reagent.impl.template.global$module$react.createElement.cljs$core$IFn$_invoke$arity$3 ? reagent.impl.template.global$module$react.createElement.cljs$core$IFn$_invoke$arity$3(G__34768,G__34769,G__34770) : reagent.impl.template.global$module$react.createElement.call(null,G__34768,G__34769,G__34770));

break;
default:
return reagent.impl.template.global$module$react.createElement.apply(null,cljs.core.reduce_kv(((function (G__34767){
