...
var G__35002 = history;
var G__35003 = goog.history.EventType.NAVIGATE;
var G__35004 = ((function (G__35002,G__35003){
return (function (e){
var token = e.token;
...
;
return goog.events.listen(G__35002,G__35003,G__35004);
});
/**
...
if(cljs.core.truth_((function (){var and__3925__auto__ = node;
...
var navigation_link_QMARK_ = (function (){var and__3925__auto__ = href;
if(cljs.core.truth_(and__3925__auto__)){
var and__3925__auto____$1 = attrs;
...
var G__35006 = document;
var G__35007 = "click";
var G__35008 = ((function (G__35006,G__35007){
return (function (e){
var target = e.target;
var button = e.button;
...
var any_key = (function (){var or__3936__auto__ = meta_key;
if(cljs.core.truth_(or__3936__auto__)){
return or__3936__auto__;
} else {
var or__3936__auto____$1 = alt_key;
if(cljs.core.truth_(or__3936__auto____$1)){
return or__3936__auto____$1;
} else {
var or__3936__auto____$2 = ctrl_key;
...
var and__3925__auto____$1 = (function (){var fexpr__35011 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, ["",null,"_self",null], null), null);
return (fexpr__35011.cljs$core$IFn$_invoke$arity$1 ? fexpr__35011.cljs$core$IFn$_invoke$arity$1(link_target) : fexpr__35011.call(null,link_target));
})();
if(cljs.core.truth_(and__3925__auto____$1)){
var and__3925__auto____$2 = cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(button,(0));
if(and__3925__auto____$2){
var and__3925__auto____$3 = cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(host,current_host);
if(and__3925__auto____$3){
var and__3925__auto____$4 = ((cljs.core.not(port)) || (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2([cljs.core.str.cljs$core$IFn$_invoke$arity$1(port)].join(''),[cljs.core.str.cljs$core$IFn$_invoke$arity$1(current_port)].join(''))));
...
var G__35012 = history;
var G__35013 = (new goog.history.Event(path,true));
return goog.events.dispatchEvent(G__35012,G__35013);
} else {
return null;
}
} else {
...
;
return goog.events.listen(G__35006,G__35007,G__35008);
});
 ...
 */
accountant.core.configure_navigation_BANG_ = (function accountant$core$configure_navigation_BANG_(p__35014){
...
var nav_handler = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__35015__$1,cljs.core.cst$kw$nav_DASH_handler);
var path_exists_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__35015__$1,cljs.core.cst$kw$path_DASH_exists_QMARK_);
var reload_same_path_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__35015__$1,cljs.core.cst$kw$reload_DASH_same_DASH_path_QMARK_);
...
var params = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__35017_SHARP_){
return cljs.core.name(p1__35017_SHARP_);
...
return clojure.string.join.cljs$core$IFn$_invoke$arity$2("=",p1__35018_SHARP_);
});})(params,values,pairs))
,pairs));
});
/**
...
if(cljs.core.truth_(accountant.core.nav_handler)){
var G__35022 = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(path),cljs.core.str.cljs$core$IFn$_invoke$arity$1(query),cljs.core.str.cljs$core$IFn$_invoke$arity$1(hash)].join('');
return (accountant.core.nav_handler.cljs$core$IFn$_invoke$arity$1 ? accountant.core.nav_handler.cljs$core$IFn$_invoke$arity$1(G__35022) : accountant.core.nav_handler.call(null,G__35022));
} else {
