...
if((i < len)){
var k = (ks[i]);
var G__32001 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(m,cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(k),reagent.impl.component.goog$module$goog$object.get(o,k));
var G__32002 = (i + (1));
m = G__32001;
i = G__32002;
continue;
...
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__31912 = c;
var G__31912__$1 = (((G__31912 == null))?null:G__31912.prototype);
if((G__31912__$1 == null)){
return null;
} else {
return G__31912__$1.reagentRender;
}
})() == null)))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__31913 = c;
var G__31913__$1 = (((G__31913 == null))?null:G__31913.prototype);
if((G__31913__$1 == null)){
return null;
} else {
return G__31913__$1.render;
}
})() == null)))));
});
...
var G__31923 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.vector,res,args);
return (reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1(G__31923) : reagent.impl.component.as_element.call(null,G__31923));
};
...
while (G__32005__i < G__32005__a.length) {G__32005__a[G__32005__i] = arguments[G__32005__i + 0]; ++G__32005__i;}
  args = new cljs.core.IndexedSeq(G__32005__a,0,null);
} 
...
var args = cljs.core.seq(arglist__32006);
...
var G__31925 = c;
var G__31925__$1 = (((G__31925 == null))?null:G__31925.constructor);
if((G__31925__$1 == null)){
return null;
} else {
return G__31925__$1.displayName;
}
});
...
var _STAR_current_component_STAR__orig_val__31959 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__31960 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__31960);
...
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__31959);
}});
...
var c = this;
var G__31993_32010 = reagent.impl.component.goog$module$goog$object.get(c,"cljsRatom");
if((G__31993_32010 == null)){
} else {
reagent.ratom.dispose_BANG_(G__31993_32010);
}
...
var renders_32011 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383)], null));
var render_fun_32012 = cljs.core.first(cljs.core.vals(renders_32011));
...
if((cljs.core.count(renders_32011) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_32011))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_32012)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_32012], 0))].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var G__31994 = o;
reagent.impl.component.goog$module$goog$object.set(G__31994,cljs.core.name(k),v);
