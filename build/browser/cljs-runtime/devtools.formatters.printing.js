...
var len__5769__auto___22244 = arguments.length;
var i__5770__auto___22245 = (0);
while(true){
if((i__5770__auto___22245 < len__5769__auto___22244)){
args__5775__auto__.push((arguments[i__5770__auto___22245]));

var G__22246 = (i__5770__auto___22245 + (1));
i__5770__auto___22245 = G__22246;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq22173){
...
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__22174,G__22175,seq22173__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__22222_SHARP_){
return (!((cljs.core.meta(p1__22222_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22224__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e22225){var _e__20878__auto__ = e22225;
return false;
}})();
if(cljs.core.truth_(or__5045__auto__)){
return or__5045__auto__;
...
}catch (e22227){var _e__20878__auto__ = e22227;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__22229 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__22230 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__22230);

try{var map__22231 = opts;
var map__22231__$1 = cljs.core.__destructure_map(map__22231);
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22231__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__22229);
}});
...
var temp__5802__auto___22258 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5802__auto___22258)){
var managed_print_level_22259 = temp__5802__auto___22258;
var _STAR_print_level_STAR__orig_val__22233_22260 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__22234_22261 = managed_print_level_22259;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__22234_22261);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__22232_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__22232_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__22233_22260);
}} else {
job_fn();
}
