...
if((x instanceof cljs.core.Keyword)){
var G__35943 = spec;
var G__35944 = spec_tools.transform.keyword__GT_string(spec,x);
return (f.cljs$core$IFn$_invoke$arity$2 ? f.cljs$core$IFn$_invoke$arity$2(G__35943,G__35944) : f.call(null,G__35943,G__35944));
} else {
if(typeof x === 'string'){
...
if((x instanceof cljs.core.Keyword)){
var G__35945 = spec;
var G__35946 = spec_tools.transform.keyword__GT_string(spec,x);
return (f.cljs$core$IFn$_invoke$arity$2 ? f.cljs$core$IFn$_invoke$arity$2(G__35945,G__35946) : f.call(null,G__35945,G__35946));
} else {
return x;
...
if(typeof x === 'number'){
var G__35949 = spec;
var G__35950 = spec_tools.transform.number__GT_string(spec,x);
return (f.cljs$core$IFn$_invoke$arity$2 ? f.cljs$core$IFn$_invoke$arity$2(G__35949,G__35950) : f.call(null,G__35949,G__35950));
} else {
if(typeof x === 'string'){
return (f.cljs$core$IFn$_invoke$arity$2 ? f.cljs$core$IFn$_invoke$arity$2(spec,x) : f.call(null,spec,x));
} else {
...
}catch (e35952){if((e35952 instanceof Error)){
var ___$1 = e35952;
return x;
} else {
throw e35952;
...
spec_tools.transform.strip_extra_keys = (function spec_tools$transform$strip_extra_keys(p__35959,x){
var map__35960 = p__35959;
var map__35960__$1 = cljs.core.__destructure_map(map__35960);
var keys = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__35960__$1,new cljs.core.Keyword("spec-tools.parse","keys","spec-tools.parse/keys",1331815460));
...
spec_tools.transform.fail_on_extra_keys = (function spec_tools$transform$fail_on_extra_keys(p__35961,x){
var map__35962 = p__35961;
var map__35962__$1 = cljs.core.__destructure_map(map__35962);
var keys = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__35962__$1,new cljs.core.Keyword("spec-tools.parse","keys","spec-tools.parse/keys",1331815460));
...
spec_tools.transform.strip_extra_values = (function spec_tools$transform$strip_extra_values(p__35963,x){
var map__35964 = p__35963;
var map__35964__$1 = cljs.core.__destructure_map(map__35964);
var items = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__35964__$1,new cljs.core.Keyword("spec-tools.parse","items","spec-tools.parse/items",1255627600));
