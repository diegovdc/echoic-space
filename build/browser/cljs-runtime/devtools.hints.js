...
var map__21679 = top_item;
var map__21679__$1 = cljs.core.__destructure_map(map__21679);
var file = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21679__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21679__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21679__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error(error.message,file,line,column);
}catch (e21678){var _e = e21678;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5802__auto___21691 = devtools.hints.get_processed_errors_BANG_();
if(cljs.core.truth_(temp__5802__auto___21691)){
var seen_errors_21692 = temp__5802__auto___21691;
if(cljs.core.truth_(seen_errors_21692.has(self))){
} else {
seen_errors_21692.add(self);

var temp__5804__auto___21693 = devtools.hints.error_object_sense(self);
if(cljs.core.truth_(temp__5804__auto___21693)){
var sense_21694 = temp__5804__auto___21693;
(self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_21694)].join(''));
} else {
}
}
} else {
